; ModuleID = '/home/zqy/LLM4CHIP/dataset/pair_slow_fast/syn_dataset/polybench/syr2k/syr2k/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_syr2k_ir(float %alpha, float %beta, [64 x float]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="64" %A, [64 x float]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="64" %B, [64 x float]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="64" %C, [64 x float]* noalias nocapture nonnull "fpga.decayed.dim.hint"="64" %D_out) local_unnamed_addr #0 {
entry:
  ...
  %6 = getelementptr inbounds [64 x [64 x float]], [64 x [64 x float]]* %C_copy, i32 0, i32 0
  %7 = getelementptr inbounds [64 x [64 x float]], [64 x [64 x float]]* %D_out_copy, i32 0, i32 0
  call void @apatb_syr2k_hw(float %alpha, float %beta, [64 x float]* %4, [64 x float]* %5, [64 x float]* %6, [64 x float]* %7)
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_out([64 x [64 x float]]* noalias, [64 x [64 x float]]* noalias readonly, [64 x [64 x float]]* noalias, [64 x [64 x float]]* noalias readonly, [64 x [64 x float]]* noalias, [64 x [64 x float]]* noalias readonly, [64 x [64 x float]]* noalias, [64 x [64 x float]]* noalias readonly) unnamed_addr #3 {
entry:
...
declare void @apatb_syr2k_hw(float, float, [64 x float]*, [64 x float]*, [64 x float]*, [64 x float]*)

; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_back([64 x [64 x float]]* noalias, [64 x [64 x float]]* noalias readonly, [64 x [64 x float]]* noalias, [64 x [64 x float]]* noalias readonly, [64 x [64 x float]]* noalias, [64 x [64 x float]]* noalias readonly, [64 x [64 x float]]* noalias, [64 x [64 x float]]* noalias readonly) unnamed_addr #3 {
entry:
  call fastcc void @onebyonecpy_hls.p0a64a64f32([64 x [64 x float]]* %6, [64 x [64 x float]]* %7)
  ret void
}

define void @syr2k_hw_stub_wrapper(float, float, [64 x float]*, [64 x float]*, [64 x float]*, [64 x float]*) #4 {
entry:
  %6 = bitcast [64 x float]* %2 to [64 x [64 x float]]*
  %7 = bitcast [64 x float]* %3 to [64 x [64 x float]]*
  %8 = bitcast [64 x float]* %4 to [64 x [64 x float]]*
  %9 = bitcast [64 x float]* %5 to [64 x [64 x float]]*
  call void @copy_out([64 x [64 x float]]* null, [64 x [64 x float]]* %6, [64 x [64 x float]]* null, [64 x [64 x float]]* %7, [64 x [64 x float]]* null, [64 x [64 x float]]* %8, [64 x [64 x float]]* null, [64 x [64 x float]]* %9)
  %10 = bitcast [64 x [64 x float]]* %6 to [64 x float]*
  %11 = bitcast [64 x [64 x float]]* %7 to [64 x float]*
  %12 = bitcast [64 x [64 x float]]* %8 to [64 x float]*
  %13 = bitcast [64 x [64 x float]]* %9 to [64 x float]*
  call void @syr2k_hw_stub(float %0, float %1, [64 x float]* %10, [64 x float]* %11, [64 x float]* %12, [64 x float]* %13)
  call void @copy_in([64 x [64 x float]]* null, [64 x [64 x float]]* %6, [64 x [64 x float]]* null, [64 x [64 x float]]* %7, [64 x [64 x float]]* null, [64 x [64 x float]]* %8, [64 x [64 x float]]* null, [64 x [64 x float]]* %9)
  ret void
}

declare void @syr2k_hw_stub(float, float, [64 x float]*, [64 x float]*, [64 x float]*, [64 x float]*)
