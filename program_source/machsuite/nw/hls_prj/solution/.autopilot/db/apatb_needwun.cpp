...
extern "C"
void needwun_hw_stub_wrapper(void*, void*, void*, void*, void*, void*);

extern "C"
void apatb_needwun_hw(void* __xlx_apatb_param_SEQA, void* __xlx_apatb_param_SEQB, void* __xlx_apatb_param_alignedA, void* __xlx_apatb_param_alignedB, void* __xlx_apatb_param_M, void* __xlx_apatb_param_ptr)
{
#ifdef USE_BINARY_TV_FILE
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port0 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_SEQA),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_SEQA),
#endif
#endif
  };
  port0.param = { __xlx_apatb_param_SEQA };
  port0.depth = { 128 };
  port0.offset = {  };
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port1 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_SEQB),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_SEQB),
#endif
#endif
  };
  port1.param = { __xlx_apatb_param_SEQB };
  port1.depth = { 128 };
  port1.offset = {  };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_alignedA),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_alignedA),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_alignedA),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_alignedA),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_alignedA),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_alignedA),
#endif
#endif
  };
  port2.param = { __xlx_apatb_param_alignedA };
  port2.depth = { 256 };
  port2.offset = {  };
  port2.hasWrite = { true };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_alignedB),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_alignedB),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_alignedB),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_alignedB),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_alignedB),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_alignedB),
#endif
#endif
  };
  port3.param = { __xlx_apatb_param_alignedB };
  port3.depth = { 256 };
  port3.offset = {  };
  port3.hasWrite = { true };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_ptr),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_ptr),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_ptr),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_ptr),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_ptr),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_ptr),
#endif
#endif
  };
  port5.param = { __xlx_apatb_param_ptr };
  port5.depth = { 16641 };
  port5.offset = {  };
  port5.hasWrite = { true };
