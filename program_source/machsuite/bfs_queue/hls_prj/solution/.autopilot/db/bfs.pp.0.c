...
__attribute__((sdx_kernel("bfs", 0))) void bfs(node_t nodes[(1<<8)], edge_t edges[((1<<8)*16)], node_index_t starting_node, level_t level[(1<<8)], edge_index_t level_counts[10]);
# 7 "bfs.c" 2
...
__attribute__((sdx_kernel("bfs", 0))) void bfs(node_t nodes[(1<<8)], edge_t edges[((1<<8)*16)], node_index_t starting_node, level_t level[(1<<8)], edge_index_t level_counts[10]){
#line 8 "/home/zqy/LLM4CHIP/HLSFactory/hlsfactory/hls_dataset_sources/machsuite/bfs_queue/hls_template.tcl"
...
# 14 "bfs.c"
  ...
  loop_queue: for( dummy=0; dummy<(1<<8); dummy++ ) {
    ...
    loop_neighbors: for( i=0; i<158; i++ ) {
      if (e < tmp_end) {
