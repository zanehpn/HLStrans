...
#define AUTOTB_TVIN_s_out "../tv/cdatafile/c.bicg.autotvin_s_out.dat"
#define AUTOTB_TVOUT_s_out "../tv/cdatafile/c.bicg.autotvout_s_out.dat"
#define AUTOTB_TVIN_q_out "../tv/cdatafile/c.bicg.autotvin_q_out.dat"
#define AUTOTB_TVOUT_q_out "../tv/cdatafile/c.bicg.autotvout_q_out.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_s_out "../tv/rtldatafile/rtl.bicg.autotvout_s_out.dat"
#define AUTOTB_TVOUT_PC_q_out "../tv/rtldatafile/rtl.bicg.autotvout_q_out.dat"
...
extern "C"
void apatb_bicg_hw(void* __xlx_apatb_param_A, void* __xlx_apatb_param_p, void* __xlx_apatb_param_r, void* __xlx_apatb_param_s_out, void* __xlx_apatb_param_q_out)
{
#ifdef USE_BINARY_TV_FILE
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_s_out),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_s_out),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_s_out),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_s_out),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_s_out),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_s_out),
#endif
#endif
  };
  port3.param = { __xlx_apatb_param_s_out };
  port3.depth = { 64 };
  port3.offset = {  };
  port3.hasWrite = { true };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_q_out),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_q_out),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_q_out),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_q_out),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_q_out),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_q_out),
#endif
#endif
  };
  port4.param = { __xlx_apatb_param_q_out };
  port4.depth = { 64 };
  port4.offset = {  };
  port4.hasWrite = { true };
  ...
  try {
    ...
    bicg_hw_stub_wrapper(__xlx_apatb_param_A, __xlx_apatb_param_p, __xlx_apatb_param_r, __xlx_apatb_param_s_out, __xlx_apatb_param_q_out);
