// Converted from cordic.c to .cpp by convert_and_transform_with_deepseek.py
...
#pragma HLS ARRAY_PARTITION variable=y_out type=cyclic dim=1 factor=16
#pragma HLS ARRAY_PARTITION variable=x_out type=cyclic dim=1 factor=16
#pragma HLS ARRAY_PARTITION variable=theta_in type=cyclic dim=1 factor=2
#pragma HLS ARRAY_PARTITION variable=y_in type=cyclic dim=1 factor=2
#pragma HLS ARRAY_PARTITION variable=x_in type=cyclic dim=1 factor=1
