// Converted from kernel_deriche.c to .cpp by convert_and_transform_with_deepseek_auto.py
...
#pragma HLS ARRAY_PARTITION variable=y2 type=cyclic dim=2 factor=1
#pragma HLS ARRAY_PARTITION variable=y2 type=cyclic dim=1 factor=1
#pragma HLS ARRAY_PARTITION variable=y1 type=cyclic dim=2 factor=1
#pragma HLS ARRAY_PARTITION variable=y1 type=cyclic dim=1 factor=1
#pragma HLS ARRAY_PARTITION variable=imgOut type=cyclic dim=2 factor=1
#pragma HLS ARRAY_PARTITION variable=imgOut type=cyclic dim=1 factor=1
#pragma HLS ARRAY_PARTITION variable=imgIn type=cyclic dim=2 factor=2
#pragma HLS ARRAY_PARTITION variable=imgIn type=cyclic dim=1 factor=2
    int i,j;
