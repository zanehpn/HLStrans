...
set C_modelArgList {
	...
	{ prod int 64 regular {array 4096 { 0 1 } 1 1 }  }
}
...
set portList { 
	...
	{ prod_address1 sc_out sc_lv 12 signal 2 } 
	{ prod_ce1 sc_out sc_logic 1 signal 2 } 
	{ prod_q1 sc_in sc_lv 64 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "prod_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "prod", "role": "address1" }} , 
 	{ "name": "prod_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "prod", "role": "ce1" }} , 
 	{ "name": "prod_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "prod", "role": "q1" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "262158", "EstimateLatencyMax" : "262158",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Loop" : [
			{"Name" : "loopjj_loopi_loopk", "PipelineType" : "UPC",
...
set ArgLastReadFirstWriteLatency {
	bbgemm {
		...
		m2 {Type I LastRead 4 FirstWrite -1}
		prod {Type IO LastRead 13 FirstWrite 13}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "262158", "Max" : "262158"}
...
set Spec2ImplPortList { 
	m1 { ap_memory {  { m1_address0 mem_address 1 12 }  { m1_ce0 mem_ce 1 1 }  { m1_q0 mem_dout 0 64 } } }
	...
	prod { ap_memory {  { prod_address0 mem_address 1 12 }  { prod_ce0 mem_ce 1 1 }  { prod_we0 mem_we 1 1 }  { prod_d0 mem_din 1 64 }  { prod_address1 MemPortADDR2 1 12 }  { prod_ce1 MemPortCE2 1 1 }  { prod_q1 MemPortDOUT2 0 64 } } }
}
