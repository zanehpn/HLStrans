...
// wrapc file define:
#define AUTOTB_TVIN_in_r "../tv/cdatafile/c.histogram.autotvin_in_r.dat"
#define AUTOTB_TVOUT_in_r "../tv/cdatafile/c.histogram.autotvout_in_r.dat"
...
extern "C"
void histogram_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_histogram_hw(void* __xlx_apatb_param_in_r, void* __xlx_apatb_param_hist)
{
#ifdef USE_BINARY_TV_FILE
  ...
  port1.param = { __xlx_apatb_param_hist };
  port1.depth = { 256 };
  port1.offset = {  };
  port1.hasWrite = { true };
  ...
  try {
    ...
    histogram_hw_stub_wrapper(__xlx_apatb_param_in_r, __xlx_apatb_param_hist);
