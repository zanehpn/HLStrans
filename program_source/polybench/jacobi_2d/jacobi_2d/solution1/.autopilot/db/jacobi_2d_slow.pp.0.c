# 1 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/jacobi_2d/jacobi_2d_slow.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/jacobi_2d/jacobi_2d_slow.c" 2

__attribute__((sdx_kernel("jacobi_2d", 0))) void jacobi_2d(int tsteps,int n,double A[90][90],double B[90][90])
{
#line 7 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/jacobi_2d/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=jacobi_2d
# 3 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/jacobi_2d/jacobi_2d_slow.c"

  int t;
  int i;
  int j;

  VITIS_LOOP_8_1: for (t = 0; t < 40; t++) {

    VITIS_LOOP_10_2: for (i = 1; i < 89; i++) {

      VITIS_LOOP_12_3: for (j = 1; j < 89; j++) {
        B[i][j] = 0.2 * (A[i][j] + A[i][j - 1] + A[i][1 + j] + A[1 + i][j] + A[i - 1][j]);
      }
    }

    VITIS_LOOP_17_4: for (i = 1; i < 89; i++) {

      VITIS_LOOP_19_5: for (j = 1; j < 89; j++) {
