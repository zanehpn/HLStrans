set moduleName stencil3d_Pipeline_loop_height_loop_col_loop_row
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {stencil3d_Pipeline_loop_height_loop_col_loop_row}
set C_modelType { void 0 }
set C_modelArgList {
	{ orig int 32 regular {array 16384 { 1 1 } 1 1 }  }
	{ C_load int 32 regular  }
	{ C_load_1 int 32 regular  }
	{ sol int 32 regular {array 16384 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ orig_address0 sc_out sc_lv 14 signal 0 } 
	{ orig_ce0 sc_out sc_logic 1 signal 0 } 
	{ orig_q0 sc_in sc_lv 32 signal 0 } 
	{ orig_address1 sc_out sc_lv 14 signal 0 } 
	{ orig_ce1 sc_out sc_logic 1 signal 0 } 
	{ orig_q1 sc_in sc_lv 32 signal 0 } 
	{ C_load sc_in sc_lv 32 signal 1 } 
	{ C_load_1 sc_in sc_lv 32 signal 2 } 
	{ sol_address0 sc_out sc_lv 14 signal 3 } 
	{ sol_ce0 sc_out sc_logic 1 signal 3 } 
	{ sol_we0 sc_out sc_logic 1 signal 3 } 
	{ sol_d0 sc_out sc_lv 32 signal 3 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32s_32s_32_1_1_U8", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "50404", "Max" : "50404"}
	, {"Name" : "Interval", "Min" : "50404", "Max" : "50404"}
]}
...
set Spec2ImplPortList { 
	orig { ap_memory {  { orig_address0 mem_address 1 14 }  { orig_ce0 mem_ce 1 1 }  { orig_q0 in_data 0 32 }  { orig_address1 MemPortADDR2 1 14 }  { orig_ce1 MemPortCE2 1 1 }  { orig_q1 in_data 0 32 } } }
	C_load { ap_none {  { C_load in_data 0 32 } } }
	C_load_1 { ap_none {  { C_load_1 in_data 0 32 } } }
	sol { ap_memory {  { sol_address0 mem_address 1 14 }  { sol_ce0 mem_ce 1 1 }  { sol_we0 mem_we 1 1 }  { sol_d0 mem_din 1 32 } } }
}
