; ModuleID = '/home/zqy/LLM4CHIP/dataset/pair_slow_fast/syn_dataset/polybench/gemm/gemm/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  call void @apatb_gemm_hw(float %alpha, float %beta, [64 x float]* %4, [64 x float]* %5, [64 x float]* %6, [64 x float]* %7)
...
declare void @apatb_gemm_hw(float, float, [64 x float]*, [64 x float]*, [64 x float]*, [64 x float]*)
...
define void @gemm_hw_stub_wrapper(float, float, [64 x float]*, [64 x float]*, [64 x float]*, [64 x float]*) #4 {
entry:
  ...
  call void @gemm_hw_stub(float %0, float %1, [64 x float]* %10, [64 x float]* %11, [64 x float]* %12, [64 x float]* %13)
