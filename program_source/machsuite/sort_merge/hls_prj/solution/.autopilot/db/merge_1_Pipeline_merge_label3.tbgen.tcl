set moduleName merge_1_Pipeline_merge_label3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {merge.1_Pipeline_merge_label3}
...
set C_modelArgList {
	...
	{ temp int 32 regular {array 2048 { 1 1 } 1 1 }  }
...
set portList { 
	...
	{ sext_ln7 sc_in sc_lv 32 signal 0 } 
	{ stop sc_in sc_lv 32 signal 1 } 
	{ start_r sc_in sc_lv 32 signal 2 } 
	{ sext_ln12_1 sc_in sc_lv 32 signal 3 } 
	{ temp_address0 sc_out sc_lv 11 signal 4 } 
	{ temp_ce0 sc_out sc_logic 1 signal 4 } 
	{ temp_q0 sc_in sc_lv 32 signal 4 } 
	{ temp_address1 sc_out sc_lv 11 signal 4 } 
	{ temp_ce1 sc_out sc_logic 1 signal 4 } 
	{ temp_q1 sc_in sc_lv 32 signal 4 } 
	{ a_address0 sc_out sc_lv 11 signal 5 } 
	{ a_ce0 sc_out sc_logic 1 signal 5 } 
	{ a_we0 sc_out sc_logic 1 signal 5 } 
	{ a_d0 sc_out sc_lv 32 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "temp_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "temp", "role": "address1" }} , 
...
set Spec2ImplPortList { 
	...
	temp { ap_memory {  { temp_address0 mem_address 1 11 }  { temp_ce0 mem_ce 1 1 }  { temp_q0 in_data 0 32 }  { temp_address1 MemPortADDR2 1 11 }  { temp_ce1 MemPortCE2 1 1 }  { temp_q1 in_data 0 32 } } }
