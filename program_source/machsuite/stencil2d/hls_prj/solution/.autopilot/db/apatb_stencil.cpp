...
extern "C"
void stencil_hw_stub_wrapper(void*, void*, void*);

extern "C"
void apatb_stencil_hw(void* __xlx_apatb_param_orig, void* __xlx_apatb_param_sol, void* __xlx_apatb_param_filter)
{
#ifdef USE_BINARY_TV_FILE
  ...
  port0.param = { __xlx_apatb_param_orig };
  port0.depth = { 8192 };
  port0.offset = {  };
  ...
  port1.param = { __xlx_apatb_param_sol };
  port1.depth = { 8192 };
  port1.offset = {  };
  port1.hasWrite = { true };
  ...
  port2.param = { __xlx_apatb_param_filter };
  port2.depth = { 9 };
  port2.offset = {  };
