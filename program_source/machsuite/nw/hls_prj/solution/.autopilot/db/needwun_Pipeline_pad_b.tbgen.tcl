set moduleName needwun_Pipeline_pad_b
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {needwun_Pipeline_pad_b}
...
set portList { 
	...
	{ alignedB_address0 sc_out sc_lv 8 signal 1 } 
	{ alignedB_ce0 sc_out sc_logic 1 signal 1 } 
	{ alignedB_we0 sc_out sc_logic 1 signal 1 } 
	{ alignedB_d0 sc_out sc_lv 8 signal 1 } 
}
set NewPortList {[ 
