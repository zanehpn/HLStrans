set moduleName mvt_Pipeline_lprd_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {mvt_Pipeline_lprd_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ A int 32 regular {array 4096 { 1 1 } 1 1 }  }
	{ buff_A float 32 regular {array 4096 { 0 0 } 0 1 }  }
	{ x1 int 32 regular {array 64 { 1 3 } 1 1 }  }
	{ buff_x1 float 32 regular {array 64 { 0 3 } 0 1 }  }
	{ x2 int 32 regular {array 64 { 1 3 } 1 1 }  }
	{ buff_x2 float 32 regular {array 64 { 0 3 } 0 1 }  }
	{ y1 int 32 regular {array 64 { 1 3 } 1 1 }  }
	{ buff_y1 float 32 regular {array 64 { 0 3 } 0 1 }  }
	{ y2 int 32 regular {array 64 { 1 3 } 1 1 }  }
	{ buff_y2 float 32 regular {array 64 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "A", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "buff_x1", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "x2", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "buff_x2", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "y1", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "buff_y1", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "y2", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "buff_y2", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ buff_A_address0 sc_out sc_lv 12 signal 1 } 
	{ buff_A_ce0 sc_out sc_logic 1 signal 1 } 
	{ buff_A_we0 sc_out sc_logic 1 signal 1 } 
	{ buff_A_d0 sc_out sc_lv 32 signal 1 } 
	{ buff_A_address1 sc_out sc_lv 12 signal 1 } 
	{ buff_A_ce1 sc_out sc_logic 1 signal 1 } 
	{ buff_A_we1 sc_out sc_logic 1 signal 1 } 
	{ buff_A_d1 sc_out sc_lv 32 signal 1 } 
	{ x1_address0 sc_out sc_lv 6 signal 2 } 
	{ x1_ce0 sc_out sc_logic 1 signal 2 } 
	{ x1_q0 sc_in sc_lv 32 signal 2 } 
	{ buff_x1_address0 sc_out sc_lv 6 signal 3 } 
	{ buff_x1_ce0 sc_out sc_logic 1 signal 3 } 
	{ buff_x1_we0 sc_out sc_logic 1 signal 3 } 
	{ buff_x1_d0 sc_out sc_lv 32 signal 3 } 
	{ x2_address0 sc_out sc_lv 6 signal 4 } 
	{ x2_ce0 sc_out sc_logic 1 signal 4 } 
	{ x2_q0 sc_in sc_lv 32 signal 4 } 
	{ buff_x2_address0 sc_out sc_lv 6 signal 5 } 
	{ buff_x2_ce0 sc_out sc_logic 1 signal 5 } 
	{ buff_x2_we0 sc_out sc_logic 1 signal 5 } 
	{ buff_x2_d0 sc_out sc_lv 32 signal 5 } 
	{ y1_address0 sc_out sc_lv 6 signal 6 } 
	{ y1_ce0 sc_out sc_logic 1 signal 6 } 
	{ y1_q0 sc_in sc_lv 32 signal 6 } 
	{ buff_y1_address0 sc_out sc_lv 6 signal 7 } 
	{ buff_y1_ce0 sc_out sc_logic 1 signal 7 } 
	{ buff_y1_we0 sc_out sc_logic 1 signal 7 } 
	{ buff_y1_d0 sc_out sc_lv 32 signal 7 } 
	{ y2_address0 sc_out sc_lv 6 signal 8 } 
	{ y2_ce0 sc_out sc_logic 1 signal 8 } 
	{ y2_q0 sc_in sc_lv 32 signal 8 } 
	{ buff_y2_address0 sc_out sc_lv 6 signal 9 } 
	{ buff_y2_ce0 sc_out sc_logic 1 signal 9 } 
	{ buff_y2_we0 sc_out sc_logic 1 signal 9 } 
	{ buff_y2_d0 sc_out sc_lv 32 signal 9 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "buff_A_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "buff_A", "role": "we1" }} , 
 	{ "name": "buff_A_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "buff_A", "role": "d1" }} , 
 	...
 	{ "name": "buff_y1_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "buff_y1", "role": "address0" }} , 
 	{ "name": "buff_y1_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "buff_y1", "role": "ce0" }} , 
 	{ "name": "buff_y1_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "buff_y1", "role": "we0" }} , 
 	{ "name": "buff_y1_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "buff_y1", "role": "d0" }} , 
 	...
 	{ "name": "buff_y2_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "buff_y2", "role": "address0" }} , 
 	{ "name": "buff_y2_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "buff_y2", "role": "ce0" }} , 
 	{ "name": "buff_y2_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "buff_y2", "role": "we0" }} , 
 	{ "name": "buff_y2_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "buff_y2", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	...
	buff_A { ap_memory {  { buff_A_address0 mem_address 1 12 }  { buff_A_ce0 mem_ce 1 1 }  { buff_A_we0 mem_we 1 1 }  { buff_A_d0 mem_din 1 32 }  { buff_A_address1 MemPortADDR2 1 12 }  { buff_A_ce1 MemPortCE2 1 1 }  { buff_A_we1 MemPortWE2 1 1 }  { buff_A_d1 MemPortDIN2 1 32 } } }
	x1 { ap_memory {  { x1_address0 mem_address 1 6 }  { x1_ce0 mem_ce 1 1 }  { x1_q0 in_data 0 32 } } }
	buff_x1 { ap_memory {  { buff_x1_address0 mem_address 1 6 }  { buff_x1_ce0 mem_ce 1 1 }  { buff_x1_we0 mem_we 1 1 }  { buff_x1_d0 mem_din 1 32 } } }
	x2 { ap_memory {  { x2_address0 mem_address 1 6 }  { x2_ce0 mem_ce 1 1 }  { x2_q0 in_data 0 32 } } }
	buff_x2 { ap_memory {  { buff_x2_address0 mem_address 1 6 }  { buff_x2_ce0 mem_ce 1 1 }  { buff_x2_we0 mem_we 1 1 }  { buff_x2_d0 mem_din 1 32 } } }
	y1 { ap_memory {  { y1_address0 mem_address 1 6 }  { y1_ce0 mem_ce 1 1 }  { y1_q0 in_data 0 32 } } }
	buff_y1 { ap_memory {  { buff_y1_address0 mem_address 1 6 }  { buff_y1_ce0 mem_ce 1 1 }  { buff_y1_we0 mem_we 1 1 }  { buff_y1_d0 mem_din 1 32 } } }
	y2 { ap_memory {  { y2_address0 mem_address 1 6 }  { y2_ce0 mem_ce 1 1 }  { y2_q0 in_data 0 32 } } }
	buff_y2 { ap_memory {  { buff_y2_address0 mem_address 1 6 }  { buff_y2_ce0 mem_ce 1 1 }  { buff_y2_we0 mem_we 1 1 }  { buff_y2_d0 mem_din 1 32 } } }
}
