// Converted from kernel_mvt.c to .cpp by convert_and_transform_with_deepseek_auto.py
...
#pragma HLS ARRAY_PARTITION variable=y_2 type=cyclic dim=1 factor=2
#pragma HLS ARRAY_PARTITION variable=y_1 type=cyclic dim=1 factor=2
#pragma HLS ARRAY_PARTITION variable=x2 type=cyclic dim=1 factor=1
#pragma HLS ARRAY_PARTITION variable=x1 type=cyclic dim=1 factor=1
  int i, j;
