...
using hls::sim::Byte;
extern "C" void syrk(float, float, Byte<4>*, Byte<4>*, Byte<4>*);
extern "C" void apatb_syrk_hw(float __xlx_apatb_param_alpha, float __xlx_apatb_param_beta, volatile void * __xlx_apatb_param_A, volatile void * __xlx_apatb_param_B, volatile void * __xlx_apatb_param_C_out) {
...
__xlx_C_out__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_C_out)[i]);
  ...
  int __xlx_size_param_C_out = 4096;
  int __xlx_offset_param_C_out = 0;
  int __xlx_offset_byte_param_C_out = 0*4;
  // DUT call
  syrk(__xlx_apatb_param_alpha, __xlx_apatb_param_beta, __xlx_A__tmp_vec.data(), __xlx_B__tmp_vec.data(), __xlx_C_out__tmp_vec.data());
