# 1 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/seidel/seidel_slow.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/seidel/seidel_slow.c" 2

__attribute__((sdx_kernel("seidel", 0))) void seidel(int tsteps,int n,double A[120][120])
{
#line 7 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/seidel/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=seidel
# 3 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/seidel/seidel_slow.c"

  int t;
  int i;
  int j;

  VITIS_LOOP_8_1: for (t = 0; t <= 39; t++) {

    VITIS_LOOP_10_2: for (i = 1; i <= 118; i++) {

      VITIS_LOOP_12_3: for (j = 1; j <= 118; j++) {
