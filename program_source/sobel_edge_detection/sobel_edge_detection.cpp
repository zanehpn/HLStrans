// Converted from sobel_edge_detection.c to .cpp by convert_and_transform_with_deepseek.py
...
#pragma HLS ARRAY_PARTITION variable=output_image type=cyclic dim=1 factor=1
#pragma HLS ARRAY_PARTITION variable=input_image type=cyclic dim=2 factor=8
