...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename llike \
    op interface \
    ports { llike_address0 { O 14 vector } llike_ce0 { O 1 bit } llike_q0 { I 64 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_min_s_out \
    op interface \
    ports { min_s_out { O 8 vector } min_s_out_ap_vld { O 1 bit } } \
} "
}
