...
module latnrm_latnrm_Pipeline_VITIS_LOOP_21_25 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [31:0] bottom_12_out;
output   bottom_12_out_ap_vld;
output  [31:0] left_5_out;
output   left_5_out_ap_vld;
...
reg coefficient_ce0;
reg coefficient_ce1;
reg bottom_12_out_ap_vld;
reg left_5_out_ap_vld;
...
reg   [31:0] mul_5_reg_327;
wire    ap_CS_fsm_pp0_stage4;
wire    ap_block_state5_pp0_stage4_iter0;
wire    ap_block_pp0_stage4_11001;
reg   [31:0] mul12_5_reg_332;
reg   [31:0] mul17_5_reg_337;
wire    ap_CS_fsm_pp0_stage5;
wire    ap_block_state6_pp0_stage5_iter0;
wire    ap_block_pp0_stage5_11001;
reg   [31:0] mul20_5_reg_342;
...
wire   [6:0] shl_ln27_5_fu_178_p3;
wire   [6:0] add_ln27_fu_186_p2;
wire   [4:0] lshr_ln27_5_fu_192_p4;
...
always @ (*) begin
    if (((icmp_ln21_reg_286 == 1'd1) & (1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        bottom_12_out_ap_vld = 1'b1;
    end else begin
        bottom_12_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((icmp_ln21_reg_286 == 1'd1) & (1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        left_5_out_ap_vld = 1'b1;
    end else begin
        left_5_out_ap_vld = 1'b0;
    end
end
...
assign add_ln21_fu_207_p2 = (ap_sig_allocacmp_j_3 + 6'd1);

assign add_ln27_fu_186_p2 = ($signed(shl_ln27_5_fu_178_p3) + $signed(7'd124));
...
assign bottom_12_out = bottom_fu_60;
...
assign icmp_ln21_fu_162_p2 = ((ap_sig_allocacmp_j_3 == 6'd32) ? 1'b1 : 1'b0);

assign internal_state_d0 = bottom_fu_60;

assign left_5_out = top_fu_56;

assign lshr_ln27_5_fu_192_p4 = {{add_ln27_fu_186_p2[6:2]}};

assign right_fu_222_p1 = internal_state_q0;

assign shl_ln27_5_fu_178_p3 = {{trunc_ln27_fu_174_p1}, {2'd0}};

assign trunc_ln27_fu_174_p1 = ap_sig_allocacmp_j_3[4:0];

assign zext_ln21_fu_168_p1 = ap_sig_allocacmp_j_3;

assign zext_ln27_fu_202_p1 = lshr_ln27_5_fu_192_p4;

endmodule //latnrm_latnrm_Pipeline_VITIS_LOOP_21_25
