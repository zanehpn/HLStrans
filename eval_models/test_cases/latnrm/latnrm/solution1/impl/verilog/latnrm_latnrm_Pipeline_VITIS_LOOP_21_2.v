...
module latnrm_latnrm_Pipeline_VITIS_LOOP_21_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [31:0] bottom_2_out;
output   bottom_2_out_ap_vld;
...
reg   [31:0] mul_reg_327;
wire    ap_CS_fsm_pp0_stage4;
wire    ap_block_state5_pp0_stage4_iter0;
wire    ap_block_pp0_stage4_11001;
reg   [31:0] mul2_reg_332;
reg   [31:0] mul3_reg_337;
wire    ap_CS_fsm_pp0_stage5;
wire    ap_block_state6_pp0_stage5_iter0;
wire    ap_block_pp0_stage5_11001;
reg   [31:0] mul4_reg_342;
...
always @ (*) begin
    if (((icmp_ln21_reg_286 == 1'd1) & (1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        bottom_2_out_ap_vld = 1'b1;
    end else begin
        bottom_2_out_ap_vld = 1'b0;
    end
end
...
assign add_ln21_fu_207_p2 = (ap_sig_allocacmp_j_5 + 6'd1);

assign add_ln27_fu_186_p2 = ($signed(shl_ln_fu_178_p3) + $signed(7'd124));
...
assign bottom_2_out = bottom_2_fu_60;
...
assign icmp_ln21_fu_162_p2 = ((ap_sig_allocacmp_j_5 == 6'd32) ? 1'b1 : 1'b0);

assign internal_state_d0 = bottom_2_fu_60;

assign left_out = top_7_fu_56;

assign lshr_ln_fu_192_p4 = {{add_ln27_fu_186_p2[6:2]}};

assign right_fu_222_p1 = internal_state_q0;

assign shl_ln_fu_178_p3 = {{trunc_ln27_fu_174_p1}, {2'd0}};

assign trunc_ln27_fu_174_p1 = ap_sig_allocacmp_j_5[4:0];

assign zext_ln21_fu_168_p1 = ap_sig_allocacmp_j_5;

assign zext_ln27_fu_202_p1 = lshr_ln_fu_192_p4;

endmodule //latnrm_latnrm_Pipeline_VITIS_LOOP_21_2
