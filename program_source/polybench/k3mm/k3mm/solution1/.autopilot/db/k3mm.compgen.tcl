...
set name k3mm_fadd_32ns_32ns_32_5_full_dsp_1
...
set name k3mm_fmul_32ns_32ns_32_4_max_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler k3mm_buff_A_RAM_1WNR_AUTO_1R1W BINDTYPE {storage} TYPE {ram_1wnr} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler k3mm_buff_E_out_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename E_out \
    op interface \
    ports { E_out_address0 { O 12 vector } E_out_ce0 { O 1 bit } E_out_we0 { O 1 bit } E_out_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'E_out'"
}
}
