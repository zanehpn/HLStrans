...
// wrapc file define:
#define AUTOTB_TVIN_alpha "../tv/cdatafile/c.gesummv.autotvin_alpha.dat"
#define AUTOTB_TVOUT_alpha "../tv/cdatafile/c.gesummv.autotvout_alpha.dat"
#define AUTOTB_TVIN_beta "../tv/cdatafile/c.gesummv.autotvin_beta.dat"
#define AUTOTB_TVOUT_beta "../tv/cdatafile/c.gesummv.autotvout_beta.dat"
...
#define AUTOTB_TVIN_y_out "../tv/cdatafile/c.gesummv.autotvin_y_out.dat"
#define AUTOTB_TVOUT_y_out "../tv/cdatafile/c.gesummv.autotvout_y_out.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_y_out "../tv/rtldatafile/rtl.gesummv.autotvout_y_out.dat"
...
extern "C"
void gesummv_hw_stub_wrapper(float, float, void*, void*, void*, void*);

extern "C"
void apatb_gesummv_hw(float __xlx_apatb_param_alpha, float __xlx_apatb_param_beta, void* __xlx_apatb_param_A, void* __xlx_apatb_param_B, void* __xlx_apatb_param_x, void* __xlx_apatb_param_y_out)
{
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_y_out),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_y_out),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_y_out),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_y_out),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_y_out),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_y_out),
#endif
#endif
  };
  port5.param = { __xlx_apatb_param_y_out };
  port5.depth = { 64 };
  port5.offset = {  };
  port5.hasWrite = { true };
  ...
  try {
    ...
    gesummv_hw_stub_wrapper(__xlx_apatb_param_alpha, __xlx_apatb_param_beta, __xlx_apatb_param_A, __xlx_apatb_param_B, __xlx_apatb_param_x, __xlx_apatb_param_y_out);
