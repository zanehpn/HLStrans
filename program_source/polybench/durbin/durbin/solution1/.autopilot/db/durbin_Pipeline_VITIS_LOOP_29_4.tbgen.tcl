set moduleName durbin_Pipeline_VITIS_LOOP_29_4
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {durbin_Pipeline_VITIS_LOOP_29_4}
set C_modelType { void 0 }
set C_modelArgList {
	{ k int 6 regular  }
	{ z double 64 regular {array 40 { 1 3 } 1 1 }  }
	{ y int 64 regular {array 40 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ z_address0 sc_out sc_lv 6 signal 1 } 
...
set Spec2ImplPortList { 
	...
	z { ap_memory {  { z_address0 mem_address 1 6 }  { z_ce0 mem_ce 1 1 }  { z_q0 in_data 0 64 } } }
	y { ap_memory {  { y_address0 mem_address 1 6 }  { y_ce0 mem_ce 1 1 }  { y_we0 mem_we 1 1 }  { y_d0 mem_din 1 64 } } }
}
