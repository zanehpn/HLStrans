// Converted from spmv.c to .cpp by convert_and_transform_with_deepseek_auto.py
...
#pragma HLS ARRAY_PARTITION variable=rowDelimiters type=cyclic dim=1 factor=1
