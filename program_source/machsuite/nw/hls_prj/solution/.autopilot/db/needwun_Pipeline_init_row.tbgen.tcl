set moduleName needwun_Pipeline_init_row
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {needwun_Pipeline_init_row}
set C_modelType { void 0 }
set C_modelArgList {
	{ M int 32 regular {array 16641 { 0 3 } 0 1 }  }
}
...
set Spec2ImplPortList { 
	M { ap_memory {  { M_address0 mem_address 1 15 }  { M_ce0 mem_ce 1 1 }  { M_we0 mem_we 1 1 }  { M_d0 mem_din 1 32 } } }
}
