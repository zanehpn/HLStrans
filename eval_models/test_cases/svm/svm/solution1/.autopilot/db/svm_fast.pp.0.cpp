# 1 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/test_cases_3B/svm/svm_fast.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 375 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/test_cases_3B/svm/svm_fast.cpp" 2
...
# 2 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/test_cases_3B/svm/svm_fast.cpp" 2
...
# 3 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/test_cases_3B/svm/svm_fast.cpp" 2
...
void svm(hls::stream<float_t> &test_vector, hls::stream<float_t> &result)
{
    float_t diff;
    float_t norma;
    float_t sum = 0;
...
#pragma HLS PIPELINE II=1
 for (int j = 0; j < 18; j++)
        {
            diff = test_vector.read() - sup_vectors[j][i];
            diff = diff * diff;
            norma = norma + diff;
        }
