...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler compute_neighbor_tables_neightbor_table_offsets_temp_RAM_2P_BRAM_1R1W BINDTYPE {storage} TYPE {ram_2p} IMPL {bram} LATENCY 2 ALLOW_PRAGMA 1
}
