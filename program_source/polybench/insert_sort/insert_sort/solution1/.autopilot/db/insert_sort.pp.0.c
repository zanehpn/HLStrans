# 1 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/insert_sort/insert_sort.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/insert_sort/insert_sort.c" 2
# 1 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/insert_sort/insert_sort.h" 1

typedef float DTYPE;

__attribute__((sdx_kernel("insert_sort", 0))) extern void insert_sort(DTYPE A[16]);
# 2 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/insert_sort/insert_sort.c" 2

__attribute__((sdx_kernel("insert_sort", 0))) void insert_sort(DTYPE A[16]) {
#line 7 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/insert_sort/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=insert_sort
# 3 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/insert_sort/insert_sort.c"

    VITIS_LOOP_4_1: for (int i = 1; i < 16; i++) {
        DTYPE item = A[i];
        int j = i;
        VITIS_LOOP_7_2: while (j > 0 && A[j - 1] > item) {
            A[j] = A[j - 1];
            j--;
        }
        A[j] = item;
