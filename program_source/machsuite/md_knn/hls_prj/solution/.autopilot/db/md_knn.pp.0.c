...
# 11 "./md_knn.h" 2
# 21 "./md_knn.h"
__attribute__((sdx_kernel("md_knn", 0))) void md_knn(double force_x[1024],
               double force_y[1024],
               double force_z[1024],
               double position_x[1024],
               double position_y[1024],
               double position_z[1024],
               int32_t NL[1024*256]);
...
__attribute__((sdx_kernel("md_knn", 0))) void md_knn(double force_x[1024], double force_y[1024], double force_z[1024], double position_x[1024], double position_y[1024], double position_z[1024], int32_t NL[1024*256])
{
#line 8 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/New/machsuite/md_knn/hls_template.tcl"
#pragma HLSDIRECTIVE TOP name=md_knn
# 11 "md_knn.c"
