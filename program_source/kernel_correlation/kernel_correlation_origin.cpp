// Converted from kernel_correlation.c to .cpp by convert_and_transform_with_deepseek_auto.py
...
{
#pragma HLS ARRAY_PARTITION variable=stddev type=cyclic dim=1 factor=1
#pragma HLS ARRAY_PARTITION variable=mean type=cyclic dim=1 factor=1
#pragma HLS ARRAY_PARTITION variable=corr type=cyclic dim=2 factor=1
#pragma HLS ARRAY_PARTITION variable=corr type=cyclic dim=1 factor=1
