set moduleName doitgen_Pipeline_VITIS_LOOP_22_5
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {doitgen_Pipeline_VITIS_LOOP_22_5}
set C_modelType { void 0 }
set C_modelArgList {
	{ sub_ln19 int 14 regular  }
	{ A int 64 regular {array 15000 { 0 3 } 0 1 }  }
	{ sum int 64 regular {array 30 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "sub_ln19", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
 	{ "Name" : "A", "interface" : "memory", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "sum", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sub_ln19 sc_in sc_lv 14 signal 0 } 
	...
	{ sum_address0 sc_out sc_lv 5 signal 2 } 
	{ sum_ce0 sc_out sc_logic 1 signal 2 } 
	{ sum_q0 sc_in sc_lv 64 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sub_ln19", "direction": "in", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "sub_ln19", "role": "default" }} , 
...
set Spec2ImplPortList { 
	sub_ln19 { ap_none {  { sub_ln19 in_data 0 14 } } }
	A { ap_memory {  { A_address0 mem_address 1 14 }  { A_ce0 mem_ce 1 1 }  { A_we0 mem_we 1 1 }  { A_d0 mem_din 1 64 } } }
	sum { ap_memory {  { sum_address0 mem_address 1 5 }  { sum_ce0 mem_ce 1 1 }  { sum_q0 mem_dout 0 64 } } }
}
