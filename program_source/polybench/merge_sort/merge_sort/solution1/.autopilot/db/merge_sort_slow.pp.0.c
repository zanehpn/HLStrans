# 1 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/merge_sort/merge_sort_slow.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/merge_sort/merge_sort_slow.c" 2
# 1 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/merge_sort/merge_sort.h" 1
const static int SIZE = 16;
const static int STAGES = 4;
typedef float DTYPE;

__attribute__((sdx_kernel("merge_sort", 0))) extern void merge_sort(DTYPE A[SIZE]);
# 2 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/merge_sort/merge_sort_slow.c" 2


void merge(DTYPE in[SIZE], int i1, int i2, int i3, DTYPE out[SIZE]) {
    int f1 = i1, f2 = i2;
    VITIS_LOOP_6_1: for (int idx = i1; idx < i3; idx++) {
...
__attribute__((sdx_kernel("merge_sort", 0))) void merge_sort(DTYPE A[SIZE]) {
#line 7 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/New/polybench/merge_sort/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=merge_sort
# 15 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/merge_sort/merge_sort_slow.c"

    DTYPE temp[SIZE];
    VITIS_LOOP_17_1: for (int width = 1; width < SIZE; width = 2 * width) {
        VITIS_LOOP_18_2: for (int i1 = 0; i1 < SIZE; i1 = i1 + 2 * width) {
            int i2 = i1 + width;
            int i3 = i1 + 2 * width;
            if (i2 >= SIZE) i2 = SIZE;
            if (i3 >= SIZE) i3 = SIZE;
        ...
        VITIS_LOOP_25_3: for (int i = 0; i < SIZE; i++) {
            A[i] = temp[i];
        }
    }
}
