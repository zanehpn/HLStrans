set moduleName latnrm_Pipeline_VITIS_LOOP_31_310
set isTopModule 0
...
set C_modelArgMapList {[ 
	{ "Name" : "internal_state", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sum_25_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ sum_25_out sc_out sc_lv 32 signal 2 } 
	{ sum_25_out_ap_vld sc_out sc_logic 1 outvld 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sum_25_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "sum_25_out", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "latnrm_Pipeline_VITIS_LOOP_31_310",
		"Protocol" : "ap_ctrl_hs",
...
set Spec2ImplPortList { 
	...
	sum_25_out { ap_vld {  { sum_25_out out_data 1 32 }  { sum_25_out_ap_vld out_vld 1 1 } } }
}
set moduleName latnrm_Pipeline_VITIS_LOOP_31_310
set isTopModule 0
set isCombinational 0
