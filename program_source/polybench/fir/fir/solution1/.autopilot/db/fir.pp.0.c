# 1 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/fir/fir.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/fir/fir.c" 2
# 1 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/fir/fir.h" 1
...
__attribute__((sdx_kernel("fir", 0))) void fir(int input, int *output, int taps[20]);
# 2 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/fir/fir.c" 2


typedef float DTYPE;
__attribute__((sdx_kernel("fir", 0))) void fir(int input, int *output, int taps[20]) {
#line 7 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/fir/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=fir
# 5 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/fir/fir.c"

    static int delay_lane[20] = {};

    int result = 0;
    VITIS_LOOP_9_1: for (int i = 20 - 1; i > 0; i--) {
        delay_lane[i] = delay_lane[i - 1];
    }
    delay_lane[0] = input;

    VITIS_LOOP_14_2: for (int i = 0; i < 20; i++) {
