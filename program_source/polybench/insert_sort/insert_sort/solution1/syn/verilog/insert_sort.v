...
wire   [30:0] trunc_ln5_fu_110_p1;
reg   [30:0] trunc_ln5_reg_168;
wire   [0:0] icmp_ln7_fu_118_p2;
reg   [0:0] icmp_ln7_reg_173;
wire   [31:0] item_fu_124_p1;
reg   [31:0] item_reg_178;
...
wire   [13:0] grp_insert_sort_Pipeline_VITIS_LOOP_7_2_fu_69_A_address0;
...
wire   [13:0] grp_insert_sort_Pipeline_VITIS_LOOP_7_2_fu_69_j_1_out;
...
reg   [13:0] j_1_loc_fu_44;
wire   [63:0] zext_ln4_fu_94_p1;
wire   [63:0] zext_ln11_fu_131_p1;
wire    ap_CS_fsm_state6;
reg   [13:0] j_fu_40;
wire   [13:0] add_ln4_fu_99_p2;
wire   [22:0] trunc_ln7_fu_114_p1;
reg   [5:0] ap_NS_fsm;
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state6)) begin
        A_address0 = zext_ln11_fu_131_p1;
...
assign add_ln4_fu_99_p2 = (j_fu_40 + 14'd1);
...
assign icmp_ln4_fu_88_p2 = ((j_fu_40 == 14'd10240) ? 1'b1 : 1'b0);

assign icmp_ln7_fu_118_p2 = ((trunc_ln7_fu_114_p1 == 23'd0) ? 1'b1 : 1'b0);

assign item_fu_124_p1 = A_load_reg_162;

assign trunc_ln5_fu_110_p1 = A_q0[30:0];

assign trunc_ln7_fu_114_p1 = A_q0[22:0];

assign zext_ln11_fu_131_p1 = j_1_loc_fu_44;
