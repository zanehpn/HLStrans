...
#define AUTOTB_TVOUT_val_r "../tv/cdatafile/c.spmv.autotvout_val_r.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_out_r "../tv/rtldatafile/rtl.spmv.autotvout_out_r.dat"
...
extern "C"
void spmv_hw_stub_wrapper(void*, void*, void*, void*, void*);

extern "C"
void apatb_spmv_hw(void* __xlx_apatb_param_val_r, void* __xlx_apatb_param_cols, void* __xlx_apatb_param_rowDelimiters, void* __xlx_apatb_param_vec, void* __xlx_apatb_param_out_r)
{
#ifdef USE_BINARY_TV_FILE
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port0 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_val_r),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_val_r),
#endif
#endif
  };
  port0.param = { __xlx_apatb_param_val_r };
  port0.depth = { 1666 };
  port0.offset = {  };
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port2 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_rowDelimiters),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_rowDelimiters),
#endif
#endif
  };
  port2.param = { __xlx_apatb_param_rowDelimiters };
  port2.depth = { 495 };
  port2.offset = {  };
  ...
  port3.param = { __xlx_apatb_param_vec };
  port3.depth = { 494 };
  port3.offset = {  };
  ...
  try {
    ...
    spmv_hw_stub_wrapper(__xlx_apatb_param_val_r, __xlx_apatb_param_cols, __xlx_apatb_param_rowDelimiters, __xlx_apatb_param_vec, __xlx_apatb_param_out_r);
