...
entity latnrm_latnrm_Pipeline_VITIS_LOOP_21_21 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    bottom_2_reload : IN STD_LOGIC_VECTOR (31 downto 0);
    top_1 : IN STD_LOGIC_VECTOR (31 downto 0);
    ...
    bottom_4_out : OUT STD_LOGIC_VECTOR (31 downto 0);
    bottom_4_out_ap_vld : OUT STD_LOGIC;
    left_1_out : OUT STD_LOGIC_VECTOR (31 downto 0);
    left_1_out_ap_vld : OUT STD_LOGIC;
...
architecture behav of latnrm_latnrm_Pipeline_VITIS_LOOP_21_21 is 
...
attribute shreg_extract : string;
    ...
    signal top_load_7_reg_305 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage1_11001 : BOOLEAN;
    signal right_fu_222_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal right_reg_311 : STD_LOGIC_VECTOR (31 downto 0);
    signal bitcast_ln27_2_fu_227_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal bitcast_ln27_2_reg_317 : STD_LOGIC_VECTOR (31 downto 0);
    signal bitcast_ln27_3_fu_232_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal bitcast_ln27_3_reg_322 : STD_LOGIC_VECTOR (31 downto 0);
    signal mul_1_reg_327 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_pp0_stage4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_pp0_stage4 : signal is "none";
    signal ap_block_state5_pp0_stage4_iter0 : BOOLEAN;
    signal ap_block_pp0_stage4_11001 : BOOLEAN;
    signal mul12_1_reg_332 : STD_LOGIC_VECTOR (31 downto 0);
    signal mul17_1_reg_337 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_pp0_stage5 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_pp0_stage5 : signal is "none";
    signal ap_block_state6_pp0_stage5_iter0 : BOOLEAN;
    signal ap_block_pp0_stage5_11001 : BOOLEAN;
    signal mul20_1_reg_342 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal bottom_4_fu_60 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_pp0_stage2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_pp0_stage2 : signal is "none";
    signal ap_block_pp0_stage2 : BOOLEAN;
    signal j_1_fu_64 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal shl_ln27_1_fu_178_p3 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln27_fu_186_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal lshr_ln27_1_fu_192_p4 : STD_LOGIC_VECTOR (4 downto 0);
...
begin
    ...
    bottom_4_fu_60_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
                bottom_4_fu_60 <= bottom_2_reload;
            elsif (((ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
                bottom_4_fu_60 <= grp_fu_6358_p_dout0;
            end if; 
        end if;
    end process;
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln21_fu_162_p2 = ap_const_lv1_0))) then 
                    j_1_fu_64 <= add_ln21_fu_207_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    j_1_fu_64 <= ap_const_lv6_1;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln21_reg_286 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then
                bitcast_ln27_2_reg_317 <= bitcast_ln27_2_fu_227_p1;
                bitcast_ln27_3_reg_322 <= bitcast_ln27_3_fu_232_p1;
                right_reg_311 <= right_fu_222_p1;
                top_load_7_reg_305 <= top_fu_56;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln21_reg_286 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage4_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage4))) then
                mul12_1_reg_332 <= grp_fu_1106_p_dout0;
                mul_1_reg_327 <= grp_fu_1102_p_dout0;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln21_reg_286 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage5_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage5))) then
                mul17_1_reg_337 <= grp_fu_1102_p_dout0;
                mul20_1_reg_342 <= grp_fu_1106_p_dout0;
            end if;
        end if;
    end process;
    ...
    add_ln21_fu_207_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_j) + unsigned(ap_const_lv6_1));
    add_ln27_fu_186_p2 <= std_logic_vector(unsigned(shl_ln27_1_fu_178_p3) + unsigned(ap_const_lv7_7C));
    ...
    bitcast_ln27_2_fu_227_p1 <= coefficient_q1;
    bitcast_ln27_3_fu_232_p1 <= coefficient_q0;
    bottom_4_out <= bottom_4_fu_60;

    bottom_4_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage1, icmp_ln21_reg_286, ap_block_pp0_stage1_11001)
    begin
        if (((icmp_ln21_reg_286 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
            bottom_4_out_ap_vld <= ap_const_logic_1;
        else 
            bottom_4_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;
    ...
    grp_fu_132_p0_assign_proc : process(ap_enable_reg_pp0_iter0, mul_1_reg_327, mul17_1_reg_337, ap_CS_fsm_pp0_stage5, ap_block_pp0_stage5, ap_CS_fsm_pp0_stage6, ap_block_pp0_stage6)
    begin
        if ((ap_enable_reg_pp0_iter0 = ap_const_logic_1)) then
            if (((ap_const_boolean_0 = ap_block_pp0_stage6) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage6))) then 
                grp_fu_132_p0 <= mul17_1_reg_337;
            elsif (((ap_const_boolean_0 = ap_block_pp0_stage5) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage5))) then 
                grp_fu_132_p0 <= mul_1_reg_327;
            else 
    ...
    grp_fu_132_p1_assign_proc : process(ap_enable_reg_pp0_iter0, mul12_1_reg_332, ap_CS_fsm_pp0_stage5, mul20_1_reg_342, ap_block_pp0_stage5, ap_CS_fsm_pp0_stage6, ap_block_pp0_stage6)
    begin
        if ((ap_enable_reg_pp0_iter0 = ap_const_logic_1)) then
            if (((ap_const_boolean_0 = ap_block_pp0_stage6) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage6))) then 
                grp_fu_132_p1 <= mul20_1_reg_342;
            elsif (((ap_const_boolean_0 = ap_block_pp0_stage5) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage5))) then 
                grp_fu_132_p1 <= mul12_1_reg_332;
            else 
    ...
    grp_fu_136_p0_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage1, bitcast_ln27_2_fu_227_p1, bitcast_ln27_2_reg_317, ap_block_pp0_stage1, ap_CS_fsm_pp0_stage2, ap_block_pp0_stage2)
    begin
        if ((ap_enable_reg_pp0_iter0 = ap_const_logic_1)) then
            if (((ap_const_boolean_0 = ap_block_pp0_stage2) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then 
                grp_fu_136_p0 <= bitcast_ln27_2_reg_317;
            elsif (((ap_const_boolean_0 = ap_block_pp0_stage1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
                grp_fu_136_p0 <= bitcast_ln27_2_fu_227_p1;
            else 
    ...
    grp_fu_140_p0_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage1, bitcast_ln27_3_fu_232_p1, bitcast_ln27_3_reg_322, ap_block_pp0_stage1, ap_CS_fsm_pp0_stage2, ap_block_pp0_stage2)
    begin
        if ((ap_enable_reg_pp0_iter0 = ap_const_logic_1)) then
            if (((ap_const_boolean_0 = ap_block_pp0_stage2) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then 
                grp_fu_140_p0 <= bitcast_ln27_3_reg_322;
            elsif (((ap_const_boolean_0 = ap_block_pp0_stage1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
                grp_fu_140_p0 <= bitcast_ln27_3_fu_232_p1;
            else 
    ...
    grp_fu_140_p1_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage1, top_load_7_reg_305, right_fu_222_p1, ap_block_pp0_stage1, ap_CS_fsm_pp0_stage2, ap_block_pp0_stage2)
    begin
        if ((ap_enable_reg_pp0_iter0 = ap_const_logic_1)) then
            if (((ap_const_boolean_0 = ap_block_pp0_stage2) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then 
                grp_fu_140_p1 <= top_load_7_reg_305;
            elsif (((ap_const_boolean_0 = ap_block_pp0_stage1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
    ...
    icmp_ln21_fu_162_p2 <= "1" when (ap_sig_allocacmp_j = ap_const_lv6_20) else "0";
    ...
    internal_state_d0 <= bottom_4_fu_60;
    ...
    left_1_out <= top_fu_56;

    left_1_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage1, icmp_ln21_reg_286, ap_block_pp0_stage1_11001)
    begin
        if (((icmp_ln21_reg_286 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
            left_1_out_ap_vld <= ap_const_logic_1;
        else 
            left_1_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    lshr_ln27_1_fu_192_p4 <= add_ln27_fu_186_p2(6 downto 2);
    right_fu_222_p1 <= internal_state_q0;
    shl_ln27_1_fu_178_p3 <= (trunc_ln27_fu_174_p1 & ap_const_lv2_0);
    trunc_ln27_fu_174_p1 <= ap_sig_allocacmp_j(5 - 1 downto 0);
    zext_ln21_fu_168_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_j),64));
    zext_ln27_fu_202_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(lshr_ln27_1_fu_192_p4),64));
end behav;
