...
#define AUTOTB_TVIN_taps "../tv/cdatafile/c.fir.autotvin_taps.dat"
#define AUTOTB_TVOUT_taps "../tv/cdatafile/c.fir.autotvout_taps.dat"
...
extern "C"
void fir_hw_stub_wrapper(hls::sim::Byte<4>, void*, void*);

extern "C"
void apatb_fir_hw(hls::sim::Byte<4> __xlx_apatb_param_input_r, void* __xlx_apatb_param_output_r, void* __xlx_apatb_param_taps)
{
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port2 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_taps),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_taps),
#endif
#endif
  };
  port2.param = { __xlx_apatb_param_taps };
  port2.depth = { 20 };
  port2.offset = {  };
  ...
  try {
    ...
    fir_hw_stub_wrapper(__xlx_apatb_param_input_r, __xlx_apatb_param_output_r, __xlx_apatb_param_taps);
