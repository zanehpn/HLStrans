...
__attribute__((sdx_kernel("stencil", 0))) void stencil (int32_t orig[128 * 64], int32_t sol[128 * 64], int32_t filter[9]){
#line 8 "/home/zqy/LLM4CHIP/HLSFactory/hlsfactory/hls_dataset_sources/machsuite/stencil2D/hls_template.tcl"
#pragma HLSDIRECTIVE TOP name=stencil
# 3 "stencil.c"
