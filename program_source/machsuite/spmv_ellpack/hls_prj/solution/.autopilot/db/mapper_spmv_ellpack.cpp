...
using hls::sim::Byte;
extern "C" void spmv_ellpack(Byte<8>*, Byte<4>*, Byte<8>*, Byte<8>*);
extern "C" void apatb_spmv_ellpack_hw(volatile void * __xlx_apatb_param_nzval, volatile void * __xlx_apatb_param_cols, volatile void * __xlx_apatb_param_vec, volatile void * __xlx_apatb_param_out_r) {
using hls::sim::createStream;
  // Collect __xlx_nzval__tmp_vec
std::vector<Byte<8>> __xlx_nzval__tmp_vec;
for (size_t i = 0; i < 1048576; ++i){
__xlx_nzval__tmp_vec.push_back(((Byte<8>*)__xlx_apatb_param_nzval)[i]);
}
  int __xlx_size_param_nzval = 1048576;
  int __xlx_offset_param_nzval = 0;
  int __xlx_offset_byte_param_nzval = 0*8;
...
__xlx_cols__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_cols)[i]);
  ...
  int __xlx_size_param_cols = 1048576;
...
__xlx_out_r__tmp_vec.push_back(((Byte<8>*)__xlx_apatb_param_out_r)[i]);
  ...
  // DUT call
  spmv_ellpack(__xlx_nzval__tmp_vec.data(), __xlx_cols__tmp_vec.data(), __xlx_vec__tmp_vec.data(), __xlx_out_r__tmp_vec.data());
// print __xlx_apatb_param_nzval
for (size_t i = 0; i < __xlx_size_param_nzval; ++i) {
((Byte<8>*)__xlx_apatb_param_nzval)[i] = __xlx_nzval__tmp_vec[__xlx_offset_param_nzval+i];
}
