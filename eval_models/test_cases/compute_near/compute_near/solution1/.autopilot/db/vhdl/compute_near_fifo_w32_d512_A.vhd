...
entity compute_near_fifo_w32_d512_A is
    generic (
...
architecture arch of compute_near_fifo_w32_d512_A is

    -- component
    component compute_near_fifo_w32_d512_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_compute_near_fifo_w32_d512_A_ram : compute_near_fifo_w32_d512_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity compute_near_fifo_w32_d512_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 32;
        ADDR_WIDTH  : integer := 9;
...
architecture arch of compute_near_fifo_w32_d512_A_ram is
