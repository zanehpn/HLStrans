; ModuleID = '/home/zqy/LLM4CHIP/dataset/pair_slow_fast/syn_dataset/polybench/bicg/bicg/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_bicg_ir([64 x float]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="64" %A, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="64" %p, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="64" %r, float* noalias nocapture nonnull "fpga.decayed.dim.hint"="64" %s_out, float* noalias nocapture nonnull "fpga.decayed.dim.hint"="64" %q_out) local_unnamed_addr #0 {
entry:
  ...
  %6 = getelementptr inbounds [64 x float], [64 x float]* %p_copy, i32 0, i32 0
  %7 = getelementptr inbounds [64 x float], [64 x float]* %r_copy, i32 0, i32 0
  %8 = getelementptr inbounds [64 x float], [64 x float]* %s_out_copy, i32 0, i32 0
  %9 = getelementptr inbounds [64 x float], [64 x float]* %q_out_copy, i32 0, i32 0
  call void @apatb_bicg_hw([64 x float]* %5, float* %6, float* %7, float* %8, float* %9)
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_out([64 x [64 x float]]* noalias, [64 x [64 x float]]* noalias readonly, [64 x float]* noalias, [64 x float]* noalias readonly align 512, [64 x float]* noalias, [64 x float]* noalias readonly align 512, [64 x float]* noalias, [64 x float]* noalias readonly align 512, [64 x float]* noalias, [64 x float]* noalias readonly align 512) unnamed_addr #3 {
entry:
...
declare void @apatb_bicg_hw([64 x float]*, float*, float*, float*, float*)

; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @copy_back([64 x [64 x float]]* noalias, [64 x [64 x float]]* noalias readonly, [64 x float]* noalias, [64 x float]* noalias readonly align 512, [64 x float]* noalias, [64 x float]* noalias readonly align 512, [64 x float]* noalias, [64 x float]* noalias readonly align 512, [64 x float]* noalias, [64 x float]* noalias readonly align 512) unnamed_addr #3 {
entry:
  call fastcc void @onebyonecpy_hls.p0a64f32([64 x float]* %6, [64 x float]* align 512 %7)
  call fastcc void @onebyonecpy_hls.p0a64f32([64 x float]* %8, [64 x float]* align 512 %9)
  ret void
...
define void @bicg_hw_stub_wrapper([64 x float]*, float*, float*, float*, float*) #4 {
entry:
  %5 = bitcast [64 x float]* %0 to [64 x [64 x float]]*
  %6 = bitcast float* %1 to [64 x float]*
  %7 = bitcast float* %2 to [64 x float]*
  %8 = bitcast float* %3 to [64 x float]*
  %9 = bitcast float* %4 to [64 x float]*
  call void @copy_out([64 x [64 x float]]* null, [64 x [64 x float]]* %5, [64 x float]* null, [64 x float]* %6, [64 x float]* null, [64 x float]* %7, [64 x float]* null, [64 x float]* %8, [64 x float]* null, [64 x float]* %9)
  %10 = bitcast [64 x [64 x float]]* %5 to [64 x float]*
  %11 = bitcast [64 x float]* %6 to float*
  %12 = bitcast [64 x float]* %7 to float*
  %13 = bitcast [64 x float]* %8 to float*
  %14 = bitcast [64 x float]* %9 to float*
  call void @bicg_hw_stub([64 x float]* %10, float* %11, float* %12, float* %13, float* %14)
  call void @copy_in([64 x [64 x float]]* null, [64 x [64 x float]]* %5, [64 x float]* null, [64 x float]* %6, [64 x float]* null, [64 x float]* %7, [64 x float]* null, [64 x float]* %8, [64 x float]* null, [64 x float]* %9)
  ret void
}
