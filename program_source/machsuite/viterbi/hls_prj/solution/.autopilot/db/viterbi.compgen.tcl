...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler viterbi_llike_RAM_1WNR_AUTO_1R1W BINDTYPE {storage} TYPE {ram_1wnr} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename init \
    op interface \
    ports { init_address0 { O 6 vector } init_ce0 { O 1 bit } init_q0 { I 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'init'"
}
}
