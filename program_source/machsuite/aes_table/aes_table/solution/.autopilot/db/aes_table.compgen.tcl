...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler aes_table_S_ROM_AUTO_1R BINDTYPE {storage} TYPE {rom} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename rk \
    op interface \
    ports { rk_address0 { O 6 vector } rk_ce0 { O 1 bit } rk_q0 { I 32 vector } rk_address1 { O 6 vector } rk_ce1 { O 1 bit } rk_q1 { I 32 vector } } \
} "
} else {
