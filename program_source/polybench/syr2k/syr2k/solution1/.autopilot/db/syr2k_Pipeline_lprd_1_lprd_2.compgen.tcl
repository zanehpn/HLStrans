...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename buff_A0 \
    op interface \
    ports { buff_A0_address0 { O 12 vector } buff_A0_ce0 { O 1 bit } buff_A0_we0 { O 1 bit } buff_A0_d0 { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename buff_A1 \
    op interface \
    ports { buff_A1_address0 { O 12 vector } buff_A1_ce0 { O 1 bit } buff_A1_we0 { O 1 bit } buff_A1_d0 { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename buff_B0 \
    op interface \
    ports { buff_B0_address0 { O 12 vector } buff_B0_ce0 { O 1 bit } buff_B0_we0 { O 1 bit } buff_B0_d0 { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename buff_D_out \
    op interface \
    ports { buff_D_out_address0 { O 12 vector } buff_D_out_ce0 { O 1 bit } buff_D_out_we0 { O 1 bit } buff_D_out_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'buff_D_out'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename tmp2 \
    op interface \
    ports { tmp2_address0 { O 12 vector } tmp2_ce0 { O 1 bit } tmp2_we0 { O 1 bit } tmp2_d0 { O 32 vector } } \
} "
} else {
