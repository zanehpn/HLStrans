# 1 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/doitgen/doitgen_slow.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/doitgen/doitgen_slow.c" 2

__attribute__((sdx_kernel("doitgen", 0))) void doitgen(int nr,int nq,int np,double A[25][20][30],double C4[30][30],double sum[30])
{
#line 7 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/doitgen/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=doitgen
# 3 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/doitgen/doitgen_slow.c"
  ...
  VITIS_LOOP_10_1: for (r = 0; r < 25; r++) {


    VITIS_LOOP_13_2: for (q = 0; q < 20; q++) {


      VITIS_LOOP_16_3: for (p = 0; p < 30; p++) {
        sum[p] = 0.0;
        VITIS_LOOP_18_4: for (s = 0; s < 30; s++) {
          sum[p] += A[r][q][s] * C4[s][p];
        }
      }
      VITIS_LOOP_22_5: for (p = 0; p < 30; p++) {
        A[r][q][p] = sum[p];
      }
    }
  }
