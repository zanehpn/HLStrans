set moduleName sort_radix_Pipeline_sum_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {sort_radix_Pipeline_sum_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ bucket int 32 regular {array 2048 { 1 3 } 1 1 }  }
	{ sum int 32 regular {array 128 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ bucket_address0 sc_out sc_lv 11 signal 0 } 
	{ bucket_ce0 sc_out sc_logic 1 signal 0 } 
	{ bucket_q0 sc_in sc_lv 32 signal 0 } 
	{ sum_address0 sc_out sc_lv 7 signal 1 } 
...
set Spec2ImplPortList { 
	bucket { ap_memory {  { bucket_address0 mem_address 1 11 }  { bucket_ce0 mem_ce 1 1 }  { bucket_q0 in_data 0 32 } } }
	sum { ap_memory {  { sum_address0 mem_address 1 7 }  { sum_ce0 mem_ce 1 1 }  { sum_we0 mem_we 1 1 }  { sum_d0 mem_din 1 32 } } }
}
