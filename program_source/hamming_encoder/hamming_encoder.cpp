// Converted from hamming_encoder.c to .cpp by convert_and_transform_with_deepseek.py
...
#pragma HLS ARRAY_PARTITION variable=data_out type=cyclic dim=1 factor=1
#pragma HLS ARRAY_PARTITION variable=data_in type=cyclic dim=1 factor=1
