...
#define AUTOTB_TVIN_force_r "../tv/cdatafile/c.md.autotvin_force_r.dat"
#define AUTOTB_TVOUT_force_r "../tv/cdatafile/c.md.autotvout_force_r.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_force_r "../tv/rtldatafile/rtl.md.autotvout_force_r.dat"
...
extern "C"
void md_hw_stub_wrapper(void*, void*, void*);

extern "C"
void apatb_md_hw(void* __xlx_apatb_param_n_points, void* __xlx_apatb_param_force_r, void* __xlx_apatb_param_position)
{
#ifdef USE_BINARY_TV_FILE
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port0 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_n_points),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_n_points),
#endif
#endif
  };
  port0.param = { __xlx_apatb_param_n_points };
  port0.depth = { 64 };
  port0.offset = {  };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_force_r),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_force_r),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_force_r),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_force_r),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_force_r),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_force_r),
#endif
#endif
  };
  port1.param = { __xlx_apatb_param_force_r };
  port1.depth = { 640 };
  port1.offset = {  };
  port1.hasWrite = { true };
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port2 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_position),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_position),
#endif
#endif
  };
  port2.param = { __xlx_apatb_param_position };
  port2.depth = { 640 };
  port2.offset = {  };
  ...
  try {
    ...
    md_hw_stub_wrapper(__xlx_apatb_param_n_points, __xlx_apatb_param_force_r, __xlx_apatb_param_position);
