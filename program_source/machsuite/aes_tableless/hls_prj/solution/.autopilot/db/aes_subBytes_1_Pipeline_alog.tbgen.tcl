set moduleName aes_subBytes_1_Pipeline_alog
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {aes_subBytes.1_Pipeline_alog}
set C_modelType { void 0 }
set C_modelArgList {
	{ sub_ln15 int 8 regular  }
	{ atb_20_out int 8 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "sub_ln15", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "atb_20_out", "interface" : "wire", "bitwidth" : 8, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ atb_20_out sc_out sc_lv 8 signal 1 } 
	{ atb_20_out_ap_vld sc_out sc_logic 1 outvld 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "atb_20_out", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "atb_20_out", "role": "default" }} , 
 	{ "name": "atb_20_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "atb_20_out", "role": "ap_vld" }}  ]}
...
set Spec2ImplPortList { 
	...
	atb_20_out { ap_vld {  { atb_20_out out_data 1 8 }  { atb_20_out_ap_vld out_vld 1 1 } } }
}
