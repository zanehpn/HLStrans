...
module sort_radix_sort_radix_Pipeline_update_1_update_22 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [63:0] zext_ln72_1_fu_294_p1;
...
assign a_address0 = zext_ln72_1_fu_294_p1;

assign a_d0 = b_load_reg_365;

assign add_ln68_1_fu_193_p2 = (ap_sig_allocacmp_blockID_load + 10'd1);

assign add_ln68_fu_167_p2 = (ap_sig_allocacmp_indvar_flatten20_load + 12'd1);

assign add_ln69_fu_228_p2 = (select_ln65_fu_185_p3 + 3'd1);

assign add_ln70_2_fu_215_p3 = {{trunc_ln65_fu_207_p1}, {trunc_ln70_fu_211_p1}};
...
assign ashr_ln70_fu_249_p2 = $signed(b_q0) >>> zext_ln63_cast_reg_346;

assign b_address0 = zext_ln70_fu_223_p1;
...
assign bucket_indx_fu_258_p3 = {{trunc_ln70_1_fu_254_p1}, {trunc_ln65_reg_355}};

assign icmp_ln68_fu_161_p2 = ((ap_sig_allocacmp_indvar_flatten20_load == 12'd2048) ? 1'b1 : 1'b0);
...
assign select_ln65_1_fu_199_p3 = ((icmp_ln69_fu_179_p2[0:0] == 1'b1) ? add_ln68_1_fu_193_p2 : ap_sig_allocacmp_blockID_load);

assign select_ln65_fu_185_p3 = ((icmp_ln69_fu_179_p2[0:0] == 1'b1) ? 3'd0 : ap_sig_allocacmp_i_load);

assign trunc_ln65_fu_207_p1 = select_ln65_1_fu_199_p3[8:0];

assign trunc_ln70_1_fu_254_p1 = ashr_ln70_fu_249_p2[1:0];

assign trunc_ln70_fu_211_p1 = select_ln65_fu_185_p3[1:0];

assign zext_ln63_cast_fu_129_p1 = zext_ln63;

assign zext_ln70_fu_223_p1 = add_ln70_2_fu_215_p3;

assign zext_ln72_1_fu_294_p1 = reuse_select_fu_287_p3;
...
endmodule //sort_radix_sort_radix_Pipeline_update_1_update_22
