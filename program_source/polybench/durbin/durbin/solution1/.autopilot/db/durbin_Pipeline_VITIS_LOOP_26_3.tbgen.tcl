set moduleName durbin_Pipeline_VITIS_LOOP_26_3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {durbin_Pipeline_VITIS_LOOP_26_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ k int 6 regular  }
	{ y int 64 regular {array 40 { 1 1 } 1 1 }  }
	{ alpha_2 double 64 regular  }
	{ z double 64 regular {array 40 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "k", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	{ "Name" : "y", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "alpha_2", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "z", "interface" : "memory", "bitwidth" : 64, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ alpha_2 sc_in sc_lv 64 signal 2 } 
	{ z_address0 sc_out sc_lv 6 signal 3 } 
	{ z_ce0 sc_out sc_logic 1 signal 3 } 
	{ z_we0 sc_out sc_logic 1 signal 3 } 
	{ z_d0 sc_out sc_lv 64 signal 3 } 
	{ grp_fu_139_p_din0 sc_out sc_lv 64 signal -1 } 
	{ grp_fu_139_p_din1 sc_out sc_lv 64 signal -1 } 
	{ grp_fu_139_p_opcode sc_out sc_lv 1 signal -1 } 
	{ grp_fu_139_p_dout0 sc_in sc_lv 64 signal -1 } 
	{ grp_fu_139_p_ce sc_out sc_logic 1 signal -1 } 
	{ grp_fu_339_p_din0 sc_out sc_lv 64 signal -1 } 
	{ grp_fu_339_p_din1 sc_out sc_lv 64 signal -1 } 
	{ grp_fu_339_p_dout0 sc_in sc_lv 64 signal -1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "alpha_2", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "alpha_2", "role": "default" }} , 
 	{ "name": "z_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "z", "role": "address0" }} , 
 	...
 	{ "name": "grp_fu_139_p_opcode", "direction": "out", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "grp_fu_139_p_opcode", "role": "default" }} , 
 	...
 	{ "name": "grp_fu_339_p_din0", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "grp_fu_339_p_din0", "role": "default" }} , 
 	{ "name": "grp_fu_339_p_din1", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "grp_fu_339_p_din1", "role": "default" }} , 
 	{ "name": "grp_fu_339_p_dout0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "grp_fu_339_p_dout0", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "13", "Max" : "51"}
	, {"Name" : "Interval", "Min" : "13", "Max" : "51"}
]}
...
set Spec2ImplPortList { 
	...
	y { ap_memory {  { y_address0 mem_address 1 6 }  { y_ce0 mem_ce 1 1 }  { y_q0 in_data 0 64 }  { y_address1 MemPortADDR2 1 6 }  { y_ce1 MemPortCE2 1 1 }  { y_q1 MemPortDOUT2 0 64 } } }
	alpha_2 { ap_none {  { alpha_2 in_data 0 64 } } }
	z { ap_memory {  { z_address0 mem_address 1 6 }  { z_ce0 mem_ce 1 1 }  { z_we0 mem_we 1 1 }  { z_d0 mem_din 1 64 } } }
}
