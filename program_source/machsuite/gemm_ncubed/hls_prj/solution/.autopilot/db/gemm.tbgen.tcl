...
set C_modelArgMapList {[ 
	{ "Name" : "m1", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "prod", "interface" : "memory", "bitwidth" : 64, "direction" : "WRITEONLY"} ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5"],
		...
		"Loop" : [
			{"Name" : "outer_middle", "PipelineType" : "UPC",
...
set ArgLastReadFirstWriteLatency {
	gemm {
		m1 {Type I LastRead 32 FirstWrite -1}
		m2 {Type I LastRead 32 FirstWrite -1}
		prod {Type O LastRead -1 FirstWrite 327}}}
