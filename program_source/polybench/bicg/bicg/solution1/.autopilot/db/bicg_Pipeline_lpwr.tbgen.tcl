set moduleName bicg_Pipeline_lpwr
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {bicg_Pipeline_lpwr}
set C_modelType { void 0 }
set C_modelArgList {
	{ buff_s_out float 32 regular {array 64 { 1 3 } 1 1 }  }
	{ s_out int 32 regular {array 64 { 0 3 } 0 1 }  }
	{ buff_q_out float 32 regular {array 64 { 1 3 } 1 1 }  }
	{ q_out int 32 regular {array 64 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "buff_s_out", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "s_out", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "buff_q_out", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ s_out_address0 sc_out sc_lv 6 signal 1 } 
	{ s_out_ce0 sc_out sc_logic 1 signal 1 } 
	{ s_out_we0 sc_out sc_logic 1 signal 1 } 
	{ s_out_d0 sc_out sc_lv 32 signal 1 } 
	{ buff_q_out_address0 sc_out sc_lv 6 signal 2 } 
	{ buff_q_out_ce0 sc_out sc_logic 1 signal 2 } 
	{ buff_q_out_q0 sc_in sc_lv 32 signal 2 } 
	{ q_out_address0 sc_out sc_lv 6 signal 3 } 
	{ q_out_ce0 sc_out sc_logic 1 signal 3 } 
	{ q_out_we0 sc_out sc_logic 1 signal 3 } 
	{ q_out_d0 sc_out sc_lv 32 signal 3 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	buff_s_out { ap_memory {  { buff_s_out_address0 mem_address 1 6 }  { buff_s_out_ce0 mem_ce 1 1 }  { buff_s_out_q0 in_data 0 32 } } }
	s_out { ap_memory {  { s_out_address0 mem_address 1 6 }  { s_out_ce0 mem_ce 1 1 }  { s_out_we0 mem_we 1 1 }  { s_out_d0 mem_din 1 32 } } }
	buff_q_out { ap_memory {  { buff_q_out_address0 mem_address 1 6 }  { buff_q_out_ce0 mem_ce 1 1 }  { buff_q_out_q0 in_data 0 32 } } }
