set moduleName aes256_encrypt_ecb_Pipeline_addkey
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {aes256_encrypt_ecb_Pipeline_addkey}
set C_modelType { void 0 }
set C_modelArgList {
	{ ctx_ret int 768 regular  }
	{ buf_r int 8 regular {array 16 { 0 1 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "ctx_ret", "interface" : "wire", "bitwidth" : 768, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ ctx_ret sc_in sc_lv 768 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ctx_ret", "direction": "in", "datatype": "sc_lv", "bitwidth":768, "type": "signal", "bundle":{"name": "ctx_ret", "role": "default" }} , 
...
set Spec2ImplPortList { 
	ctx_ret { ap_none {  { ctx_ret in_data 0 768 } } }
