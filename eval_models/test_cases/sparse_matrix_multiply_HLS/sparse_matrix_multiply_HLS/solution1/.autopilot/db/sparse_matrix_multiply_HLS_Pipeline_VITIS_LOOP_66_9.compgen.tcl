...
set id 16
set name sparse_matrix_multiply_HLS_mac_muladd_16s_16s_27ns_27_4_1
...
set ce_signed 0
set out_width 27
set arg_lists {i0 {16 1 +} i1 {16 1 +} m {27 1 +} i2 {27 0 +} p {27 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { local_values_B_V_address0 { O 12 vector } local_values_B_V_ce0 { O 1 bit } local_values_B_V_q0 { I 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { local_row_indices_B_address0 { O 12 vector } local_row_indices_B_ce0 { O 1 bit } local_row_indices_B_q0 { I 12 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename accum_V \
    op interface \
    ports { accum_V_address0 { O 12 vector } accum_V_ce0 { O 1 bit } accum_V_we0 { O 1 bit } accum_V_d0 { O 16 vector } accum_V_q0 { I 16 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln1347 \
    op interface \
    ports { sext_ln1347 { I 16 vector } } \
} "
}
