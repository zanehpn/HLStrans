set moduleName fdtd_2d_Pipeline_VITIS_LOOP_36_7_VITIS_LOOP_38_8
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {fdtd_2d_Pipeline_VITIS_LOOP_36_7_VITIS_LOOP_38_8}
set C_modelType { void 0 }
set C_modelArgList {
	{ ex int 64 regular {array 4800 { 1 1 } 1 1 }  }
	{ ey int 64 regular {array 4800 { 1 1 } 1 1 }  }
	{ hz int 64 regular {array 4800 { 0 1 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "ex", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "ey", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ ex_address0 sc_out sc_lv 13 signal 0 } 
	{ ex_ce0 sc_out sc_logic 1 signal 0 } 
	{ ex_q0 sc_in sc_lv 64 signal 0 } 
	{ ex_address1 sc_out sc_lv 13 signal 0 } 
	{ ex_ce1 sc_out sc_logic 1 signal 0 } 
	{ ex_q1 sc_in sc_lv 64 signal 0 } 
	{ ey_address0 sc_out sc_lv 13 signal 1 } 
	{ ey_ce0 sc_out sc_logic 1 signal 1 } 
	{ ey_q0 sc_in sc_lv 64 signal 1 } 
	{ ey_address1 sc_out sc_lv 13 signal 1 } 
	{ ey_ce1 sc_out sc_logic 1 signal 1 } 
	{ ey_q1 sc_in sc_lv 64 signal 1 } 
	{ hz_address0 sc_out sc_lv 13 signal 2 } 
	{ hz_ce0 sc_out sc_logic 1 signal 2 } 
	{ hz_we0 sc_out sc_logic 1 signal 2 } 
	{ hz_d0 sc_out sc_lv 64 signal 2 } 
	{ hz_address1 sc_out sc_lv 13 signal 2 } 
	{ hz_ce1 sc_out sc_logic 1 signal 2 } 
	{ hz_q1 sc_in sc_lv 64 signal 2 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dsub_64ns_64ns_64_5_full_dsp_1_U15", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dsub_64ns_64ns_64_5_full_dsp_1_U16", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4690", "Max" : "4690"}
	, {"Name" : "Interval", "Min" : "4690", "Max" : "4690"}
]}
...
set Spec2ImplPortList { 
	ex { ap_memory {  { ex_address0 mem_address 1 13 }  { ex_ce0 mem_ce 1 1 }  { ex_q0 mem_dout 0 64 }  { ex_address1 MemPortADDR2 1 13 }  { ex_ce1 MemPortCE2 1 1 }  { ex_q1 MemPortDOUT2 0 64 } } }
	ey { ap_memory {  { ey_address0 mem_address 1 13 }  { ey_ce0 mem_ce 1 1 }  { ey_q0 mem_dout 0 64 }  { ey_address1 MemPortADDR2 1 13 }  { ey_ce1 MemPortCE2 1 1 }  { ey_q1 MemPortDOUT2 0 64 } } }
	hz { ap_memory {  { hz_address0 mem_address 1 13 }  { hz_ce0 mem_ce 1 1 }  { hz_we0 mem_we 1 1 }  { hz_d0 mem_din 1 64 }  { hz_address1 MemPortADDR2 1 13 }  { hz_ce1 MemPortCE2 1 1 }  { hz_q1 MemPortDOUT2 0 64 } } }
}
