...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler atax_buff_A_0_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler atax_buff_x_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler atax_buff_y_out_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename y_out \
    op interface \
    ports { y_out_address0 { O 6 vector } y_out_ce0 { O 1 bit } y_out_we0 { O 1 bit } y_out_d0 { O 32 vector } } \
} "
} else {
