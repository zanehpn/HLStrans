// Converted from kernel_doitgen.c to .cpp by convert_and_transform_with_deepseek_auto.py
...
#pragma HLS ARRAY_PARTITION variable=C4 type=cyclic dim=2 factor=8
#pragma HLS ARRAY_PARTITION variable=C4 type=cyclic dim=1 factor=1
#pragma HLS ARRAY_PARTITION variable=A type=cyclic dim=3 factor=1
