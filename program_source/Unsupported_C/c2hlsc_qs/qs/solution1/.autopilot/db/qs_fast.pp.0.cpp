# 1 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/New/c2hlsc/c2hlsc_quicksort__WIP/qs_fast.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 375 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/New/c2hlsc/c2hlsc_quicksort__WIP/qs_fast.cpp" 2
...
# 2 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/New/c2hlsc/c2hlsc_quicksort__WIP/qs_fast.cpp" 2
...
# 3 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/New/c2hlsc/c2hlsc_quicksort__WIP/qs_fast.cpp" 2
...
extern "C" {
__attribute__((sdx_kernel("qs", 0))) void qs(DataT arr[MAX_N], int n) {
#line 7 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/New/c2hlsc/c2hlsc_quicksort__WIP/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=qs
# 9 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/New/c2hlsc/c2hlsc_quicksort__WIP/qs_fast.cpp"
...
#pragma HLS PIPELINE II=1
 int low = stack_low[top];
        ...
        DataT pivot = arr[low];
        int i = low, j = high;
        VITIS_LOOP_32_2: while (i < j) {
#pragma HLS LOOP_TRIPCOUNT min=1 max=MAX_N
#pragma HLS PIPELINE II=1
 VITIS_LOOP_35_3: while (i < j && arr[j] > pivot) --j;
            if (i < j) arr[i++] = arr[j];
            VITIS_LOOP_37_4: while (i < j && arr[i] <= pivot) ++i;
            if (i < j) arr[j--] = arr[i];
        }
        arr[i] = pivot;
        int p = i;
