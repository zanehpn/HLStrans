...
using hls::sim::Byte;
extern "C" void histogram(Byte<4>*, Byte<4>*);
extern "C" void apatb_histogram_hw(volatile void * __xlx_apatb_param_in_r, volatile void * __xlx_apatb_param_hist) {
...
__xlx_in_r__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_in_r)[i]);
  ...
  int __xlx_size_param_in_r = 10240;
...
__xlx_hist__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_hist)[i]);
  ...
  int __xlx_size_param_hist = 256;
  int __xlx_offset_param_hist = 0;
  int __xlx_offset_byte_param_hist = 0*4;
  // DUT call
  histogram(__xlx_in_r__tmp_vec.data(), __xlx_hist__tmp_vec.data());
