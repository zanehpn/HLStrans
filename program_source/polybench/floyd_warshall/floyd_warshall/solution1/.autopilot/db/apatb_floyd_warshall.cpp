...
// wrapc file define:
#define AUTOTB_TVIN_path "../tv/cdatafile/c.floyd_warshall.autotvin_path.dat"
#define AUTOTB_TVOUT_path "../tv/cdatafile/c.floyd_warshall.autotvout_path.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_path "../tv/rtldatafile/rtl.floyd_warshall.autotvout_path.dat"
...
extern "C"
void floyd_warshall_hw_stub_wrapper(void*);

extern "C"
void apatb_floyd_warshall_hw(void* __xlx_apatb_param_path)
{
#ifdef USE_BINARY_TV_FILE
  ...
  port0.param = { __xlx_apatb_param_path };
  port0.depth = { 3600 };
  port0.offset = {  };
  port0.hasWrite = { true };
  ...
  try {
    ...
    floyd_warshall_hw_stub_wrapper(__xlx_apatb_param_path);
