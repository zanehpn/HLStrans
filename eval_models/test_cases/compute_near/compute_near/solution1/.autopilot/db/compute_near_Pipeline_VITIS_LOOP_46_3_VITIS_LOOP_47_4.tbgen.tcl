set moduleName compute_near_Pipeline_VITIS_LOOP_46_3_VITIS_LOOP_47_4
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {compute_near_Pipeline_VITIS_LOOP_46_3_VITIS_LOOP_47_4}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 32 regular {axi_master 0}  }
	{ sext_ln41 int 62 regular  }
	{ searchStream int 32 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "inputQuery","offset": { "type": "dynamic","port_name": "inputQuery","bundle": "control"},"direction": "READONLY"},{"cName": "searchSpace","offset": { "type": "dynamic","port_name": "searchSpace","bundle": "control"},"direction": "READONLY"},{"cName": "distance","offset": { "type": "dynamic","port_name": "distance","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln41", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "searchStream", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ searchStream_din sc_out sc_lv 32 signal 2 } 
	{ searchStream_full_n sc_in sc_logic 1 signal 2 } 
	{ searchStream_write sc_out sc_logic 1 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "searchStream_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "searchStream", "role": "din" }} , 
 	{ "name": "searchStream_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "searchStream", "role": "full_n" }} , 
 	{ "name": "searchStream_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "searchStream", "role": "write" }} , 
 	{ "name": "sext_ln41", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln41", "role": "default" }}  ]}

set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "compute_near_Pipeline_VITIS_LOOP_46_3_VITIS_LOOP_47_4",
		"Protocol" : "ap_ctrl_hs",
...
set Spec2ImplPortList { 
	...
	searchStream { ap_fifo {  { searchStream_din fifo_port_we 1 32 }  { searchStream_full_n fifo_status 0 1 }  { searchStream_write fifo_data 1 1 } } }
}
set moduleName compute_near_Pipeline_VITIS_LOOP_46_3_VITIS_LOOP_47_4
set isTopModule 0
set isCombinational 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "inputQuery","offset": { "type": "dynamic","port_name": "inputQuery","bundle": "control"},"direction": "READONLY"},{"cName": "searchSpace","offset": { "type": "dynamic","port_name": "searchSpace","bundle": "control"},"direction": "READONLY"},{"cName": "distance","offset": { "type": "dynamic","port_name": "distance","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
...
set portList { 
	...
	{ ap_idle sc_out sc_logic 1 done -1 } 
	{ ap_ready sc_out sc_logic 1 ready -1 } 
	{ searchStream_dout sc_in sc_lv 32 signal 2 } 
	{ searchStream_empty_n sc_in sc_logic 1 signal 2 } 
	{ searchStream_read sc_out sc_logic 1 signal 2 } 
	{ queryStream_dout sc_in sc_lv 32 signal 3 } 
	{ queryStream_empty_n sc_in sc_logic 1 signal 3 } 
	{ queryStream_read sc_out sc_logic 1 signal 3 } 
	{ m_axi_gmem_AWVALID sc_out sc_logic 1 signal 0 } 
	{ m_axi_gmem_AWREADY sc_in sc_logic 1 signal 0 } 
	{ m_axi_gmem_AWADDR sc_out sc_lv 64 signal 0 } 
	{ m_axi_gmem_AWID sc_out sc_lv 1 signal 0 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4"],
		...
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "2097174", "EstimateLatencyMax" : "2097174",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Loop" : [
			{"Name" : "VITIS_LOOP_46_3_VITIS_LOOP_47_4", "PipelineType" : "UPC",
				"LoopDec" : {"FSMBitwidth" : "2", "FirstState" : "ap_ST_fsm_pp0_stage0", "FirstStateIter" : "ap_enable_reg_pp0_iter0", "FirstStateBlock" : "ap_block_pp0_stage0_subdone", "LastState" : "ap_ST_fsm_pp0_stage1", "LastStateIter" : "ap_enable_reg_pp0_iter10", "LastStateBlock" : "ap_block_pp0_stage1_subdone", "QuitState" : "ap_ST_fsm_pp0_stage0", "QuitStateIter" : "ap_enable_reg_pp0_iter10", "QuitStateBlock" : "ap_block_pp0_stage0_subdone", "OneDepthLoop" : "0", "has_ap_ctrl" : "1", "has_continue" : "0"}}]},
...
set ArgLastReadFirstWriteLatency {
	compute_near_Pipeline_VITIS_LOOP_46_3_VITIS_LOOP_47_4 {
		gmem {Type O LastRead -1 FirstWrite 21}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2097174", "Max" : "2097174"}
	, {"Name" : "Interval", "Min" : "2097174", "Max" : "2097174"}
]}
