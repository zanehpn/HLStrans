...
entity latnrm_latnrm_Pipeline_VITIS_LOOP_19_21 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    bottom_1_reload : IN STD_LOGIC_VECTOR (31 downto 0);
    top_3 : IN STD_LOGIC_VECTOR (31 downto 0);
    ...
    bottom_3_out : OUT STD_LOGIC_VECTOR (31 downto 0);
    bottom_3_out_ap_vld : OUT STD_LOGIC;
...
architecture behav of latnrm_latnrm_Pipeline_VITIS_LOOP_19_21 is 
...
attribute shreg_extract : string;
    ...
    signal internal_state_addr_7_reg_298 : STD_LOGIC_VECTOR (5 downto 0);
    signal top_load_7_reg_313 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal bitcast_ln25_2_fu_235_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal bitcast_ln25_2_reg_325 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal ap_sig_allocacmp_top_load_7 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage1 : BOOLEAN;
    signal ap_loop_init : STD_LOGIC;
    signal ap_block_pp0_stage3 : BOOLEAN;
    signal bottom_3_fu_60 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage3_11001 : BOOLEAN;
    signal ap_block_pp0_stage4 : BOOLEAN;
    signal j_2_fu_64 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal shl_ln25_1_fu_186_p3 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln25_fu_194_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal lshr_ln25_1_fu_200_p4 : STD_LOGIC_VECTOR (4 downto 0);
...
begin
    ...
    bottom_3_fu_60_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
                bottom_3_fu_60 <= bottom_1_reload;
                ...
                bottom_3_fu_60 <= grp_fu_1215_p_dout0;
            end if; 
        end if;
    end process;
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln19_fu_170_p2 = ap_const_lv1_0))) then 
                    j_2_fu_64 <= add_ln19_fu_215_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    j_2_fu_64 <= ap_const_lv6_1;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln19_reg_294 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then
                bitcast_ln25_2_reg_325 <= bitcast_ln25_2_fu_235_p1;
                bitcast_ln25_3_reg_330 <= bitcast_ln25_3_fu_240_p1;
                right_reg_319 <= right_fu_230_p1;
                top_load_7_reg_313 <= ap_sig_allocacmp_top_load_7;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln19_fu_170_p2 = ap_const_lv1_0))) then
                internal_state_addr_7_reg_298 <= zext_ln19_fu_176_p1(6 - 1 downto 0);
            end if;
        end if;
    end process;
    ...
    add_ln25_fu_194_p2 <= std_logic_vector(unsigned(shl_ln25_1_fu_186_p3) + unsigned(ap_const_lv7_7C));
    ...
    ap_sig_allocacmp_j_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, j_2_fu_64)
    begin
    ...
    ap_sig_allocacmp_top_load_7_assign_proc : process(ap_enable_reg_pp0_iter1, ap_CS_fsm_pp0_stage1, top_fu_56, ap_block_pp0_stage1, grp_fu_1211_p_dout0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
            ap_sig_allocacmp_top_load_7 <= grp_fu_1211_p_dout0;
        else 
            ap_sig_allocacmp_top_load_7 <= top_fu_56;
        end if; 
    end process;

    bitcast_ln25_2_fu_235_p1 <= coefficient_q1;
    bitcast_ln25_3_fu_240_p1 <= coefficient_q0;
    bottom_3_out <= bottom_3_fu_60;

    bottom_3_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage3, icmp_ln19_reg_294, ap_block_pp0_stage3_11001)
    begin
        if (((icmp_ln19_reg_294 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage3_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage3))) then 
            bottom_3_out_ap_vld <= ap_const_logic_1;
        else 
            bottom_3_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;
    ...
    grp_fu_140_p0_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage1, bitcast_ln25_2_fu_235_p1, bitcast_ln25_2_reg_325, ap_block_pp0_stage1, ap_CS_fsm_pp0_stage2, ap_block_pp0_stage2)
    begin
        if ((ap_enable_reg_pp0_iter0 = ap_const_logic_1)) then
            if (((ap_const_boolean_0 = ap_block_pp0_stage2) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then 
                grp_fu_140_p0 <= bitcast_ln25_2_reg_325;
            elsif (((ap_const_boolean_0 = ap_block_pp0_stage1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
                grp_fu_140_p0 <= bitcast_ln25_2_fu_235_p1;
            else 
    ...
    grp_fu_140_p1_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage1, right_reg_319, ap_sig_allocacmp_top_load_7, ap_block_pp0_stage1, ap_CS_fsm_pp0_stage2, ap_block_pp0_stage2)
    begin
        if ((ap_enable_reg_pp0_iter0 = ap_const_logic_1)) then
            if (((ap_const_boolean_0 = ap_block_pp0_stage2) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then 
                grp_fu_140_p1 <= right_reg_319;
            elsif (((ap_const_boolean_0 = ap_block_pp0_stage1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
                grp_fu_140_p1 <= ap_sig_allocacmp_top_load_7;
            else 
    ...
    grp_fu_145_p1_assign_proc : process(ap_enable_reg_pp0_iter0, top_load_7_reg_313, ap_CS_fsm_pp0_stage1, right_fu_230_p1, ap_block_pp0_stage1, ap_CS_fsm_pp0_stage2, ap_block_pp0_stage2)
    begin
        if ((ap_enable_reg_pp0_iter0 = ap_const_logic_1)) then
            if (((ap_const_boolean_0 = ap_block_pp0_stage2) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then 
                grp_fu_145_p1 <= top_load_7_reg_313;
            elsif (((ap_const_boolean_0 = ap_block_pp0_stage1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
    ...
    internal_state_address0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, internal_state_addr_7_reg_298, ap_CS_fsm_pp0_stage4, zext_ln19_fu_176_p1, ap_block_pp0_stage0, ap_block_pp0_stage4)
    begin
        if ((ap_enable_reg_pp0_iter0 = ap_const_logic_1)) then
            if (((ap_const_boolean_0 = ap_block_pp0_stage4) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage4))) then 
                internal_state_address0 <= internal_state_addr_7_reg_298;
    ...
    internal_state_d0 <= bottom_3_fu_60;
    ...
    left_1_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage3, icmp_ln19_reg_294, ap_block_pp0_stage3_11001)
    begin
        if (((icmp_ln19_reg_294 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage3_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage3))) then 
    ...
    lshr_ln25_1_fu_200_p4 <= add_ln25_fu_194_p2(6 downto 2);
    right_fu_230_p1 <= internal_state_q0;
    shl_ln25_1_fu_186_p3 <= (trunc_ln25_fu_182_p1 & ap_const_lv2_0);
    ...
    zext_ln25_fu_210_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(lshr_ln25_1_fu_200_p4),64));
end behav;
