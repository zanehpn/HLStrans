...
__attribute__((sdx_kernel("md", 0))) void md( int n_points[4][4][4], dvector_t force[4][4][4][10], dvector_t position[4][4][4][10] )
{
#line 8 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/New/machsuite/md_grid/hls_template.tcl"
#pragma HLSDIRECTIVE TOP name=md
# 7 "md_grid.c"
...
#pragma HLS loop_tripcount min=0 max=10 avg=10/2
