...
using hls::sim::Byte;
extern "C" void syr2k(float, float, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*);
extern "C" void apatb_syr2k_hw(float __xlx_apatb_param_alpha, float __xlx_apatb_param_beta, volatile void * __xlx_apatb_param_A, volatile void * __xlx_apatb_param_B, volatile void * __xlx_apatb_param_C, volatile void * __xlx_apatb_param_D_out) {
...
std::vector<Byte<4>> __xlx_D_out__tmp_vec;
for (size_t i = 0; i < 4096; ++i){
__xlx_D_out__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_D_out)[i]);
}
  int __xlx_size_param_D_out = 4096;
  int __xlx_offset_param_D_out = 0;
  int __xlx_offset_byte_param_D_out = 0*4;
  // DUT call
  syr2k(__xlx_apatb_param_alpha, __xlx_apatb_param_beta, __xlx_A__tmp_vec.data(), __xlx_B__tmp_vec.data(), __xlx_C__tmp_vec.data(), __xlx_D_out__tmp_vec.data());
...
for (size_t i = 0; i < __xlx_size_param_D_out; ++i) {
((Byte<4>*)__xlx_apatb_param_D_out)[i] = __xlx_D_out__tmp_vec[__xlx_offset_param_D_out+i];
}
}
