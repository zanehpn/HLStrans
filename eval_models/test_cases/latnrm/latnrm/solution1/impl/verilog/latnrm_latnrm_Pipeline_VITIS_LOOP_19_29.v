...
module latnrm_latnrm_Pipeline_VITIS_LOOP_19_29 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [31:0] bottom_11_out;
output   bottom_11_out_ap_vld;
...
reg   [31:0] top_fu_56;
reg   [31:0] ap_sig_allocacmp_top_load_1;
...
wire   [6:0] shl_ln25_5_fu_186_p3;
wire   [6:0] add_ln25_fu_194_p2;
wire   [4:0] lshr_ln25_5_fu_200_p4;
reg    ap_done_reg;
...
always @ (*) begin
    if (((icmp_ln19_reg_294 == 1'd1) & (1'b0 == ap_block_pp0_stage3_11001) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        bottom_11_out_ap_vld = 1'b1;
    end else begin
        bottom_11_out_ap_vld = 1'b0;
    end
end
...
assign add_ln19_fu_215_p2 = (ap_sig_allocacmp_j_7 + 6'd1);

assign add_ln25_fu_194_p2 = ($signed(shl_ln25_5_fu_186_p3) + $signed(7'd124));
...
assign bottom_11_out = bottom_fu_60;
...
assign icmp_ln19_fu_170_p2 = ((ap_sig_allocacmp_j_7 == 6'd32) ? 1'b1 : 1'b0);

assign internal_state_d0 = bottom_fu_60;

assign left_5_out = top_fu_56;

assign lshr_ln25_5_fu_200_p4 = {{add_ln25_fu_194_p2[6:2]}};

assign right_fu_230_p1 = internal_state_q0;

assign shl_ln25_5_fu_186_p3 = {{trunc_ln25_fu_182_p1}, {2'd0}};

assign trunc_ln25_fu_182_p1 = ap_sig_allocacmp_j_7[4:0];

assign zext_ln19_fu_176_p1 = ap_sig_allocacmp_j_7;

assign zext_ln25_fu_210_p1 = lshr_ln25_5_fu_200_p4;

endmodule //latnrm_latnrm_Pipeline_VITIS_LOOP_19_29
