...
module latnrm_latnrm_Pipeline_VITIS_LOOP_19_21 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [31:0] bottom_3_out;
output   bottom_3_out_ap_vld;
output  [31:0] left_1_out;
output   left_1_out_ap_vld;
...
reg coefficient_ce0;
reg coefficient_ce1;
reg bottom_3_out_ap_vld;
reg left_1_out_ap_vld;
...
reg   [5:0] internal_state_addr_7_reg_298;
reg   [31:0] top_load_7_reg_313;
...
wire   [31:0] bitcast_ln25_2_fu_235_p1;
reg   [31:0] bitcast_ln25_2_reg_325;
wire   [31:0] bitcast_ln25_3_fu_240_p1;
reg   [31:0] bitcast_ln25_3_reg_330;
...
reg   [31:0] top_fu_56;
reg   [31:0] ap_sig_allocacmp_top_load_7;
wire    ap_block_pp0_stage1;
wire    ap_loop_init;
wire    ap_block_pp0_stage3;
reg   [31:0] bottom_3_fu_60;
...
wire   [6:0] shl_ln25_1_fu_186_p3;
wire   [6:0] add_ln25_fu_194_p2;
wire   [4:0] lshr_ln25_1_fu_200_p4;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln19_fu_170_p2 == 1'd0))) begin
        internal_state_addr_7_reg_298 <= zext_ln19_fu_176_p1;
    end
end
...
always @ (*) begin
    if (((icmp_ln19_reg_294 == 1'd1) & (1'b0 == ap_block_pp0_stage3_11001) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        bottom_3_out_ap_vld = 1'b1;
    end else begin
        bottom_3_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((icmp_ln19_reg_294 == 1'd1) & (1'b0 == ap_block_pp0_stage3_11001) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        left_1_out_ap_vld = 1'b1;
    end else begin
        left_1_out_ap_vld = 1'b0;
    end
end
...
assign add_ln19_fu_215_p2 = (ap_sig_allocacmp_j + 6'd1);

assign add_ln25_fu_194_p2 = ($signed(shl_ln25_1_fu_186_p3) + $signed(7'd124));
...
assign bitcast_ln25_2_fu_235_p1 = coefficient_q1;

assign bitcast_ln25_3_fu_240_p1 = coefficient_q0;

assign bottom_3_out = bottom_3_fu_60;
...
assign icmp_ln19_fu_170_p2 = ((ap_sig_allocacmp_j == 6'd32) ? 1'b1 : 1'b0);

assign internal_state_d0 = bottom_3_fu_60;

assign left_1_out = top_fu_56;

assign lshr_ln25_1_fu_200_p4 = {{add_ln25_fu_194_p2[6:2]}};

assign right_fu_230_p1 = internal_state_q0;

assign shl_ln25_1_fu_186_p3 = {{trunc_ln25_fu_182_p1}, {2'd0}};

assign trunc_ln25_fu_182_p1 = ap_sig_allocacmp_j[4:0];

assign zext_ln19_fu_176_p1 = ap_sig_allocacmp_j;

assign zext_ln25_fu_210_p1 = lshr_ln25_1_fu_200_p4;

endmodule //latnrm_latnrm_Pipeline_VITIS_LOOP_19_21
