...
# 12 "./sort_radix.h" 2
# 27 "./sort_radix.h"
__attribute__((sdx_kernel("sort_radix", 0))) void sort_radix(int a[2048], int b[2048], int bucket[512*4], int sum[512*4/16]);
...
void sum_scan(int sum[512*4/16], int bucket[512*4])
{
...
void last_step_scan(int bucket[512*4], int sum[512*4/16])
{
    int radixID, i, bucket_indx;
...
void hist(int bucket[512*4], int a[2048], int exp)
{
...
void update(int b[2048], int bucket[512*4], int a[2048], int exp)
{
...
__attribute__((sdx_kernel("sort_radix", 0))) void sort_radix(int a[2048], int b[2048], int bucket[512*4], int sum[512*4/16]){
#line 8 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/New/machsuite/sort_radix/hls_template.tcl"
#pragma HLSDIRECTIVE TOP name=sort_radix
# 78 "sort_radix.c"
