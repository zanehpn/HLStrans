...
set id 3
set name latnrm_mux_616_32_1_1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename coeff_V \
    op interface \
    ports { coeff_V_address0 { O 6 vector } coeff_V_ce0 { O 1 bit } coeff_V_we0 { O 1 bit } coeff_V_d0 { O 32 vector } coeff_V_address1 { O 6 vector } coeff_V_ce1 { O 1 bit } coeff_V_we1 { O 1 bit } coeff_V_d1 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'coeff_V'"
}
}
