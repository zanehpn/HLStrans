...
// wrapc file define:
#define AUTOTB_TVIN_test_vector "../tv/cdatafile/c.svm.autotvin_test_vector.dat"
#define AUTOTB_TVOUT_test_vector "../tv/cdatafile/c.svm.autotvout_test_vector.dat"
#define AUTOTB_TVOUT_return "../tv/cdatafile/c.svm.autotvout_ap_return.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_return "../tv/rtldatafile/rtl.svm.autotvout_ap_return.dat"
...
extern "C"
hls::sim::Byte<4> svm_hw_stub_wrapper(void*);

extern "C"
hls::sim::Byte<4> apatb_svm_hw(void* __xlx_apatb_param_test_vector)
{
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port1 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_test_vector),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_test_vector),
#endif
#endif
  };
  port1.param = { __xlx_apatb_param_test_vector };
  port1.depth = { 18 };
  port1.offset = {  };
  ...
  try {
    ...
    ap_return = svm_hw_stub_wrapper(__xlx_apatb_param_test_vector);
