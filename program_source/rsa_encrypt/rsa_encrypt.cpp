// Converted from rsa_encrypt.c to .cpp by convert_and_transform_with_deepseek.py
...
#pragma HLS ARRAY_PARTITION variable=encrypted_message type=cyclic dim=1 factor=4
#pragma HLS ARRAY_PARTITION variable=message type=cyclic dim=1 factor=1
    for (int i = 0; i < N; i++) {
