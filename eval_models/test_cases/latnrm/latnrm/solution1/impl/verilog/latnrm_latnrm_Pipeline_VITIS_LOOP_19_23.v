...
module latnrm_latnrm_Pipeline_VITIS_LOOP_19_23 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [31:0] bottom_5_out;
output   bottom_5_out_ap_vld;
...
reg   [5:0] internal_state_addr_12_reg_298;
reg   [31:0] top_load_4_reg_313;
...
wire   [31:0] bitcast_ln25_4_fu_240_p1;
reg   [31:0] bitcast_ln25_4_reg_330;
...
reg   [31:0] top_fu_56;
reg   [31:0] ap_sig_allocacmp_top_load_4;
...
wire   [6:0] shl_ln25_2_fu_186_p3;
wire   [6:0] add_ln25_fu_194_p2;
wire   [4:0] lshr_ln25_2_fu_200_p4;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln19_fu_170_p2 == 1'd0))) begin
        internal_state_addr_12_reg_298 <= zext_ln19_fu_176_p1;
    end
end
...
always @ (*) begin
    if (((icmp_ln19_reg_294 == 1'd1) & (1'b0 == ap_block_pp0_stage3_11001) & (1'b1 == ap_CS_fsm_pp0_stage3))) begin
        bottom_5_out_ap_vld = 1'b1;
    end else begin
        bottom_5_out_ap_vld = 1'b0;
    end
end
...
assign add_ln25_fu_194_p2 = ($signed(shl_ln25_2_fu_186_p3) + $signed(7'd124));
...
assign bitcast_ln25_4_fu_240_p1 = coefficient_q0;

assign bitcast_ln25_fu_235_p1 = coefficient_q1;

assign bottom_5_out = bottom_fu_60;
...
assign lshr_ln25_2_fu_200_p4 = {{add_ln25_fu_194_p2[6:2]}};

assign right_fu_230_p1 = internal_state_q0;

assign shl_ln25_2_fu_186_p3 = {{trunc_ln25_fu_182_p1}, {2'd0}};

assign trunc_ln25_fu_182_p1 = ap_sig_allocacmp_j[4:0];

assign zext_ln19_fu_176_p1 = ap_sig_allocacmp_j;

assign zext_ln25_fu_210_p1 = lshr_ln25_2_fu_200_p4;

endmodule //latnrm_latnrm_Pipeline_VITIS_LOOP_19_23
