set moduleName stencil3d_Pipeline_height_bound_col_height_bound_row
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {stencil3d_Pipeline_height_bound_col_height_bound_row}
...
set portList { 
	...
	{ sol_address0 sc_out sc_lv 14 signal 1 } 
...
set Spec2ImplPortList { 
	orig { ap_memory {  { orig_address0 mem_address 1 14 }  { orig_ce0 mem_ce 1 1 }  { orig_q0 mem_dout 0 32 }  { orig_address1 MemPortADDR2 1 14 }  { orig_ce1 MemPortCE2 1 1 }  { orig_q1 in_data 0 32 } } }
