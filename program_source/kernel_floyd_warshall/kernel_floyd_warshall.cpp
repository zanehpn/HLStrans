// Converted from kernel_floyd_warshall.c to .cpp by convert_and_transform_with_deepseek_auto.py
...
{
#pragma HLS ARRAY_PARTITION variable=path type=cyclic dim=2 factor=1
#pragma HLS ARRAY_PARTITION variable=path type=cyclic dim=1 factor=1
  int i, j, k;
