// Converted from aes256_encrypt_ecb.c to .cpp by convert_and_transform_with_deepseek_auto.py
...
void aes256_encrypt_ecb(aes256_context *ctx, uint8_t k[32], uint8_t buf[16])
{
#pragma HLS ARRAY_PARTITION variable=buf type=cyclic dim=1 factor=1
