...
extern "C"
hls::sim::Byte<4> viterbi_hw_stub_wrapper(void*, void*, void*, void*, void*);

extern "C"
hls::sim::Byte<4> apatb_viterbi_hw(void* __xlx_apatb_param_obs, void* __xlx_apatb_param_init, void* __xlx_apatb_param_transition, void* __xlx_apatb_param_emission, void* __xlx_apatb_param_path)
{
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port1 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_obs),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_obs),
#endif
#endif
  };
  port1.param = { __xlx_apatb_param_obs };
  port1.depth = { 140 };
  port1.offset = {  };
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port2 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_init),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_init),
#endif
#endif
  };
  port2.param = { __xlx_apatb_param_init };
  port2.depth = { 64 };
  port2.offset = {  };
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port3 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_transition),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_transition),
#endif
#endif
  };
  port3.param = { __xlx_apatb_param_transition };
  port3.depth = { 4096 };
  port3.offset = {  };
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port4 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_emission),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_emission),
#endif
#endif
  };
  port4.param = { __xlx_apatb_param_emission };
  port4.depth = { 4096 };
  port4.offset = {  };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_path),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_path),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_path),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_path),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_path),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_path),
#endif
#endif
  };
  port5.param = { __xlx_apatb_param_path };
  port5.depth = { 140 };
  port5.offset = {  };
  port5.hasWrite = { true };
  ...
  try {
    ...
    ap_return = viterbi_hw_stub_wrapper(__xlx_apatb_param_obs, __xlx_apatb_param_init, __xlx_apatb_param_transition, __xlx_apatb_param_emission, __xlx_apatb_param_path);
