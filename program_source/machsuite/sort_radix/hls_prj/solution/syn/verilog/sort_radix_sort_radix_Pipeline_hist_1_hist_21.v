...
module sort_radix_sort_radix_Pipeline_hist_1_hist_21 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [10:0] bucket_addr_2_reg_365;
...
wire   [9:0] select_ln52_1_fu_188_p3;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        bucket_addr_2_reg_365 <= zext_ln58_fu_270_p1;
...
assign add_ln54_1_fu_182_p2 = (ap_sig_allocacmp_blockID_load + 10'd1);

assign add_ln54_fu_156_p2 = (ap_sig_allocacmp_indvar_flatten6_load + 12'd1);

assign add_ln55_fu_217_p2 = (select_ln52_fu_174_p3 + 3'd1);

assign add_ln57_4_fu_204_p3 = {{trunc_ln52_fu_196_p1}, {trunc_ln56_fu_200_p1}};
...
assign ashr_ln57_fu_241_p2 = $signed(b_q0) >>> zext_ln63_cast_reg_346;

assign b_address0 = zext_ln57_fu_212_p1;

assign bucket_address0 = bucket_addr_2_reg_365;
...
assign icmp_ln54_fu_150_p2 = ((ap_sig_allocacmp_indvar_flatten6_load == 12'd2048) ? 1'b1 : 1'b0);

assign icmp_ln55_fu_168_p2 = ((ap_sig_allocacmp_i_load == 3'd4) ? 1'b1 : 1'b0);

assign or_ln57_fu_258_p2 = (shl_ln57_1_fu_250_p3 | 11'd1);

assign reuse_select_fu_292_p3 = ((addr_cmp_reg_371[0:0] == 1'b1) ? reuse_reg_fu_66 : bucket_q1);

assign select_ln52_1_fu_188_p3 = ((icmp_ln55_fu_168_p2[0:0] == 1'b1) ? add_ln54_1_fu_182_p2 : ap_sig_allocacmp_blockID_load);

assign select_ln52_fu_174_p3 = ((icmp_ln55_fu_168_p2[0:0] == 1'b1) ? 3'd0 : ap_sig_allocacmp_i_load);

assign shl_ln57_1_fu_250_p3 = {{trunc_ln57_fu_246_p1}, {9'd0}};

assign trunc_ln52_fu_196_p1 = select_ln52_1_fu_188_p3[8:0];
...
assign zext_ln57_fu_212_p1 = add_ln57_4_fu_204_p3;
...
endmodule //sort_radix_sort_radix_Pipeline_hist_1_hist_21
