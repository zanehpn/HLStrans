...
// wrapc file define:
#define AUTOTB_TVIN_seq "../tv/cdatafile/c.nussinov.autotvin_seq.dat"
#define AUTOTB_TVOUT_seq "../tv/cdatafile/c.nussinov.autotvout_seq.dat"
#define AUTOTB_TVIN_table_r "../tv/cdatafile/c.nussinov.autotvin_table_r.dat"
#define AUTOTB_TVOUT_table_r "../tv/cdatafile/c.nussinov.autotvout_table_r.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_table_r "../tv/rtldatafile/rtl.nussinov.autotvout_table_r.dat"
...
extern "C"
void nussinov_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_nussinov_hw(void* __xlx_apatb_param_seq, void* __xlx_apatb_param_table_r)
{
#ifdef USE_BINARY_TV_FILE
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port0 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_seq),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_seq),
#endif
#endif
  };
  port0.param = { __xlx_apatb_param_seq };
  port0.depth = { 60 };
  port0.offset = {  };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_table_r),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_table_r),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_table_r),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_table_r),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_table_r),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_table_r),
#endif
#endif
  };
  port1.param = { __xlx_apatb_param_table_r };
  port1.depth = { 3600 };
  port1.offset = {  };
  port1.hasWrite = { true };
  ...
  try {
    ...
    nussinov_hw_stub_wrapper(__xlx_apatb_param_seq, __xlx_apatb_param_table_r);
