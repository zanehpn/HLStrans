...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_searchStream \
    op interface \
    ports { searchStream_dout { I 32 vector } searchStream_empty_n { I 1 bit } searchStream_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_queryStream \
    op interface \
    ports { queryStream_dout { I 32 vector } queryStream_empty_n { I 1 bit } queryStream_read { O 1 bit } } \
} "
}
...
set InstName compute_near_flow_control_loop_pipe_sequential_init_U
set CompName compute_near_flow_control_loop_pipe_sequential_init
set name flow_control_loop_pipe_sequential_init
if {${::AESL::PGuard_autocg_gen} && ${::AESL::PGuard_autocg_ipmgen}} {
if {[info proc ::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control] == "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control"} {
eval "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control { \
    name ${name} \
    prefix compute_near_ \
}"
} else {
