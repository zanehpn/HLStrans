...
using hls::sim::Byte;
extern "C" void aes_table(Byte<1>*, Byte<1>*, Byte<4>*);
extern "C" void apatb_aes_table_hw(volatile void * __xlx_apatb_param_in_r, volatile void * __xlx_apatb_param_out_r, volatile void * __xlx_apatb_param_rk) {
...
__xlx_out_r__tmp_vec.push_back(((Byte<1>*)__xlx_apatb_param_out_r)[i]);
  ...
  int __xlx_size_param_out_r = 16;
  int __xlx_offset_param_out_r = 0;
  int __xlx_offset_byte_param_out_r = 0*1;
  // Collect __xlx_rk__tmp_vec
std::vector<Byte<4>> __xlx_rk__tmp_vec;
for (size_t i = 0; i < 60; ++i){
__xlx_rk__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_rk)[i]);
}
  int __xlx_size_param_rk = 60;
  int __xlx_offset_param_rk = 0;
  int __xlx_offset_byte_param_rk = 0*4;
  // DUT call
  aes_table(__xlx_in_r__tmp_vec.data(), __xlx_out_r__tmp_vec.data(), __xlx_rk__tmp_vec.data());
...
for (size_t i = 0; i < __xlx_size_param_rk; ++i) {
((Byte<4>*)__xlx_apatb_param_rk)[i] = __xlx_rk__tmp_vec[__xlx_offset_param_rk+i];
}
}
