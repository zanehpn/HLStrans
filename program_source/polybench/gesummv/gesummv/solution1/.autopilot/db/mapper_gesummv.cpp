...
using hls::sim::Byte;
extern "C" void gesummv(float, float, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*);
extern "C" void apatb_gesummv_hw(float __xlx_apatb_param_alpha, float __xlx_apatb_param_beta, volatile void * __xlx_apatb_param_A, volatile void * __xlx_apatb_param_B, volatile void * __xlx_apatb_param_x, volatile void * __xlx_apatb_param_y_out) {
...
__xlx_x__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_x)[i]);
  ...
  int __xlx_size_param_x = 64;
  int __xlx_offset_param_x = 0;
  int __xlx_offset_byte_param_x = 0*4;
  // Collect __xlx_y_out__tmp_vec
std::vector<Byte<4>> __xlx_y_out__tmp_vec;
for (size_t i = 0; i < 64; ++i){
__xlx_y_out__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_y_out)[i]);
}
  int __xlx_size_param_y_out = 64;
  int __xlx_offset_param_y_out = 0;
  int __xlx_offset_byte_param_y_out = 0*4;
  // DUT call
  gesummv(__xlx_apatb_param_alpha, __xlx_apatb_param_beta, __xlx_A__tmp_vec.data(), __xlx_B__tmp_vec.data(), __xlx_x__tmp_vec.data(), __xlx_y_out__tmp_vec.data());
...
// print __xlx_apatb_param_y_out
for (size_t i = 0; i < __xlx_size_param_y_out; ++i) {
((Byte<4>*)__xlx_apatb_param_y_out)[i] = __xlx_y_out__tmp_vec[__xlx_offset_param_y_out+i];
}
}
