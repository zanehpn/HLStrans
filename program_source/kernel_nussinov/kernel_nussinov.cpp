// Converted from kernel_nussinov.c to .cpp by convert_and_transform_with_deepseek_auto.py
...
{
#pragma HLS ARRAY_PARTITION variable=table type=cyclic dim=2 factor=1
#pragma HLS ARRAY_PARTITION variable=table type=cyclic dim=1 factor=1
#pragma HLS ARRAY_PARTITION variable=seq type=cyclic dim=1 factor=1
  int i, j, k;
