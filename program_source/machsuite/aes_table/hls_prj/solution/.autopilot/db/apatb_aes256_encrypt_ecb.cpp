...
#define AUTOTB_TVIN_buf_r "../tv/cdatafile/c.aes256_encrypt_ecb.autotvin_buf_r.dat"
#define AUTOTB_TVOUT_buf_r "../tv/cdatafile/c.aes256_encrypt_ecb.autotvout_buf_r.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_ctx "../tv/rtldatafile/rtl.aes256_encrypt_ecb.autotvout_ctx.dat"
#define AUTOTB_TVOUT_PC_buf_r "../tv/rtldatafile/rtl.aes256_encrypt_ecb.autotvout_buf_r.dat"
...
extern "C"
void aes256_encrypt_ecb_hw_stub_wrapper(void*, void*, void*);

extern "C"
void apatb_aes256_encrypt_ecb_hw(void* __xlx_apatb_param_ctx, void* __xlx_apatb_param_k, void* __xlx_apatb_param_buf_r)
{
  static hls::sim::Register port0 {
    .name = "ctx",
    .width = 768,
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_ctx),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_ctx),
  ...
  port2.param = { __xlx_apatb_param_buf_r };
  port2.depth = { 16 };
  port2.offset = {  };
  port2.hasWrite = { true };
  ...
  try {
    ...
    aes256_encrypt_ecb_hw_stub_wrapper(__xlx_apatb_param_ctx, __xlx_apatb_param_k, __xlx_apatb_param_buf_r);
