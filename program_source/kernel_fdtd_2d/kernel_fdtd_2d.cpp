// Converted from kernel_fdtd_2d.c to .cpp by convert_and_transform_with_deepseek_auto.py
...
{
#pragma HLS ARRAY_PARTITION variable=_fict_ type=cyclic dim=1 factor=4
#pragma HLS ARRAY_PARTITION variable=hz type=cyclic dim=2 factor=1
#pragma HLS ARRAY_PARTITION variable=hz type=cyclic dim=1 factor=1
#pragma HLS ARRAY_PARTITION variable=ey type=cyclic dim=2 factor=4
#pragma HLS ARRAY_PARTITION variable=ey type=cyclic dim=1 factor=2
#pragma HLS ARRAY_PARTITION variable=ex type=cyclic dim=2 factor=2
#pragma HLS ARRAY_PARTITION variable=ex type=cyclic dim=1 factor=1
  int t, i, j;
