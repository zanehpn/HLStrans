...
L4:    float result_inner                          [TILE_ROWS  *              NVAR ];
L5:    float elements_surrounding_elements_inner   [TILE_ROWS  * NNB               ];
L6:    float normals_inner                         [TILE_ROWS  * NNB * NDIM        ];
L7:    float variables_inner                       [SIZE       *              NVAR ];
L8:    float fc_momentum_x_inner                   [SIZE       *       NDIM        ];
L9:    float fc_momentum_y_inner                   [SIZE       *       NDIM        ];
L10:    float fc_momentum_z_inner                   [SIZE       *       NDIM        ];
L11:    float fc_density_energy_inner               [SIZE       *       NDIM        ];
