set moduleName sort_radix_Pipeline_init_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {sort_radix_Pipeline_init_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ bucket int 32 regular {array 2048 { 0 3 } 0 1 }  }
}
...
set Spec2ImplPortList { 
	bucket { ap_memory {  { bucket_address0 mem_address 1 11 }  { bucket_ce0 mem_ce 1 1 }  { bucket_we0 mem_we 1 1 }  { bucket_d0 mem_din 1 32 } } }
}
