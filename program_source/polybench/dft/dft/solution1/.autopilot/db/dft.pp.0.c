# 1 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/dft/dft.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/dft/dft.c" 2
...
# 2 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/dft/dft.c" 2
# 1 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/dft/dft.h" 1
...
__attribute__((sdx_kernel("dft", 0))) void dft(IN_TYPE sample_real[256], IN_TYPE sample_imag[256]);
# 3 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/dft/dft.c" 2
...
__attribute__((sdx_kernel("dft", 0))) void dft(IN_TYPE sample_real[256], IN_TYPE sample_imag[256]) {
#line 7 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/dft/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=dft
# 8 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/dft/dft.c"
    ...
    VITIS_LOOP_16_1: for (int i = 0; i < 256; i++) {
        ...
        w = (2.0 * 3.141592653589 / 256) * (TEMP_TYPE)i;

        VITIS_LOOP_22_2: for (j = 0; j < 256; j++) {
            c = cos(j * w);
            s = sin(j * w);
    ...
    VITIS_LOOP_31_3: for (int i = 0; i < 256; i++) {
