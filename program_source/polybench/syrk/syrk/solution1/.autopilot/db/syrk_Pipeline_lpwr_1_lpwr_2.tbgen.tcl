set moduleName syrk_Pipeline_lpwr_1_lpwr_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {syrk_Pipeline_lpwr_1_lpwr_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ C_out int 32 regular {array 4096 { 0 3 } 0 1 }  }
	{ buff_C_out float 32 regular {array 4096 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "C_out", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "buff_C_out", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ C_out_address0 sc_out sc_lv 12 signal 0 } 
	{ C_out_ce0 sc_out sc_logic 1 signal 0 } 
	{ C_out_we0 sc_out sc_logic 1 signal 0 } 
	{ C_out_d0 sc_out sc_lv 32 signal 0 } 
	{ buff_C_out_address0 sc_out sc_lv 12 signal 1 } 
	{ buff_C_out_ce0 sc_out sc_logic 1 signal 1 } 
	{ buff_C_out_q0 sc_in sc_lv 32 signal 1 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	...
	buff_C_out { ap_memory {  { buff_C_out_address0 mem_address 1 12 }  { buff_C_out_ce0 mem_ce 1 1 }  { buff_C_out_q0 in_data 0 32 } } }
}
