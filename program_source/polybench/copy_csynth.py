...
SRC_ROOT = "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/New/polybench"
...
def main():
    ...
    for sub in os.listdir(SRC_ROOT):
        ...
        rpt_path = os.path.join(src_subdir, sub, "solution1", "syn", "report", "csynth.rpt")
