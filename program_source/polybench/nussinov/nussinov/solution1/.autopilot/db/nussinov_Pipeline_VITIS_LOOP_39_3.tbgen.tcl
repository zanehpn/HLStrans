set moduleName nussinov_Pipeline_VITIS_LOOP_39_3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {nussinov_Pipeline_VITIS_LOOP_39_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ select_ln24 int 32 regular  }
	{ zext_ln10 int 6 regular  }
	{ table_r int 32 regular {array 3600 { 2 1 } 1 1 }  }
	{ add_ln15 int 12 regular  }
	{ sub_ln15 int 12 regular  }
	{ zext_ln11 int 12 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "select_ln24", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln10", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	{ "Name" : "table_r", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	{ "Name" : "add_ln15", "interface" : "wire", "bitwidth" : 12, "direction" : "READONLY"} , 
 	{ "Name" : "sub_ln15", "interface" : "wire", "bitwidth" : 12, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ select_ln24 sc_in sc_lv 32 signal 0 } 
	{ zext_ln10 sc_in sc_lv 6 signal 1 } 
	...
	{ add_ln15 sc_in sc_lv 12 signal 3 } 
	{ sub_ln15 sc_in sc_lv 12 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "select_ln24", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "select_ln24", "role": "default" }} , 
 	...
 	{ "name": "add_ln15", "direction": "in", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "add_ln15", "role": "default" }} , 
 	{ "name": "sub_ln15", "direction": "in", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "sub_ln15", "role": "default" }} , 
...
set Spec2ImplPortList { 
	select_ln24 { ap_none {  { select_ln24 in_data 0 32 } } }
	...
	add_ln15 { ap_none {  { add_ln15 in_data 0 12 } } }
	sub_ln15 { ap_none {  { sub_ln15 in_data 0 12 } } }
...
set C_modelArgMapList {[ 
	{ "Name" : "select_ln24", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "add_ln15", "interface" : "wire", "bitwidth" : 12, "direction" : "READONLY"} , 
 	{ "Name" : "sub_ln15", "interface" : "wire", "bitwidth" : 12, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln10", "interface" : "wire", "bitwidth" : 12, "direction" : "READONLY"} ]}
# RTL Port declarations: 
set portNum 19
set portList { 
	{ ap_clk sc_in sc_logic 1 clock -1 } 
	...
	{ add_ln15 sc_in sc_lv 12 signal 3 } 
	{ sub_ln15 sc_in sc_lv 12 signal 4 } 
	{ zext_ln10 sc_in sc_lv 12 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	{ "name": "ap_rst", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "reset", "bundle":{"name": "ap_rst", "role": "default" }} , 
 	...
 	{ "name": "add_ln15", "direction": "in", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "add_ln15", "role": "default" }} , 
 	{ "name": "sub_ln15", "direction": "in", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "sub_ln15", "role": "default" }} , 
 	{ "name": "zext_ln10", "direction": "in", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "zext_ln10", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	add_ln15 { ap_none {  { add_ln15 in_data 0 12 } } }
	sub_ln15 { ap_none {  { sub_ln15 in_data 0 12 } } }
	zext_ln10 { ap_none {  { zext_ln10 in_data 0 12 } } }
}
