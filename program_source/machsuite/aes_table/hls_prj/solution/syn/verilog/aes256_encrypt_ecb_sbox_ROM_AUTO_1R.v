...
// ==============================================================
`timescale 1 ns / 1 ps
module aes256_encrypt_ecb_sbox_ROM_AUTO_1R (
    address0, ce0, q0, 
    address1, ce1, q1, 
    address2, ce2, q2, 
    address3, ce3, q3, 
...
initial begin
    ...
    $readmemh("./aes256_encrypt_ecb_sbox_ROM_AUTO_1R.dat", rom0); 
    $readmemh("./aes256_encrypt_ecb_sbox_ROM_AUTO_1R.dat", rom1); 
    $readmemh("./aes256_encrypt_ecb_sbox_ROM_AUTO_1R.dat", rom2); 
    $readmemh("./aes256_encrypt_ecb_sbox_ROM_AUTO_1R.dat", rom3);
end
