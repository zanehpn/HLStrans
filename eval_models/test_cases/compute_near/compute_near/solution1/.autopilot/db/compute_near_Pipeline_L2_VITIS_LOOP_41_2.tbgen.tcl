set moduleName compute_near_Pipeline_L2_VITIS_LOOP_41_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {compute_near_Pipeline_L2_VITIS_LOOP_41_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 32 regular {axi_master 0}  }
	{ sext_ln43 int 62 regular  }
	{ searchStream int 32 regular {fifo 0 volatile }  }
	{ resultStream int 32 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "inputQuery","offset": { "type": "dynamic","port_name": "inputQuery","bundle": "control"},"direction": "READONLY"},{"cName": "searchSpace","offset": { "type": "dynamic","port_name": "searchSpace","bundle": "control"},"direction": "READONLY"},{"cName": "distance","offset": { "type": "dynamic","port_name": "distance","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "resultStream", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ resultStream_din sc_out sc_lv 32 signal 3 } 
	{ resultStream_full_n sc_in sc_logic 1 signal 3 } 
	{ resultStream_write sc_out sc_logic 1 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "resultStream_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "resultStream", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4"],
		"CDFG" : "compute_near_Pipeline_L2_VITIS_LOOP_41_2",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "2097180", "EstimateLatencyMax" : "2097180",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			...
			{"Name" : "resultStream", "Type" : "Fifo", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "resultStream_blk_n", "Type" : "RtlSignal"}]}],
		"Loop" : [
			{"Name" : "L2_VITIS_LOOP_41_2", "PipelineType" : "UPC",
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fsub_32ns_32ns_32_5_full_dsp_1_U4", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fadd_32ns_32ns_32_5_full_dsp_1_U5", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fmul_32ns_32ns_32_4_max_dsp_1_U6", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.flow_control_loop_pipe_sequential_init_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	compute_near_Pipeline_L2_VITIS_LOOP_41_2 {
		gmem {Type I LastRead 9 FirstWrite -1}
		sext_ln43 {Type I LastRead 0 FirstWrite -1}
		searchStream {Type I LastRead 9 FirstWrite -1}
		resultStream {Type O LastRead -1 FirstWrite 28}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2097180", "Max" : "2097180"}
	, {"Name" : "Interval", "Min" : "2097180", "Max" : "2097180"}
]}
...
set Spec2ImplPortList { 
	...
	resultStream { ap_fifo {  { resultStream_din fifo_port_we 1 32 }  { resultStream_full_n fifo_status 0 1 }  { resultStream_write fifo_data 1 1 } } }
}
