...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("A_address1", 14, hls_out, 2, "ap_memory", "MemPortADDR2", 1),
	Port_Property("A_ce1", 1, hls_out, 2, "ap_memory", "MemPortCE2", 1),
	Port_Property("A_q1", 64, hls_in, 2, "ap_memory", "MemPortDOUT2", 1),
};
const char* HLS_Design_Meta::dut_name = "seidel";
