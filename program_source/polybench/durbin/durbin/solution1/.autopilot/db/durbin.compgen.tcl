...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler durbin_z_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename y \
    op interface \
    ports { y_address0 { O 6 vector } y_ce0 { O 1 bit } y_we0 { O 1 bit } y_d0 { O 64 vector } y_q0 { I 64 vector } y_address1 { O 6 vector } y_ce1 { O 1 bit } y_q1 { I 64 vector } } \
} "
} else {
