...
using hls::sim::Byte;
extern "C" void k2mm(float, float, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*);
extern "C" void apatb_k2mm_hw(float __xlx_apatb_param_alpha, float __xlx_apatb_param_beta, volatile void * __xlx_apatb_param_A, volatile void * __xlx_apatb_param_B, volatile void * __xlx_apatb_param_C, volatile void * __xlx_apatb_param_D, volatile void * __xlx_apatb_param_E_out) {
...
__xlx_D__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_D)[i]);
  ...
  int __xlx_size_param_D = 4096;
  int __xlx_offset_param_D = 0;
  int __xlx_offset_byte_param_D = 0*4;
  // Collect __xlx_E_out__tmp_vec
std::vector<Byte<4>> __xlx_E_out__tmp_vec;
for (size_t i = 0; i < 4096; ++i){
__xlx_E_out__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_E_out)[i]);
}
  int __xlx_size_param_E_out = 4096;
  int __xlx_offset_param_E_out = 0;
  int __xlx_offset_byte_param_E_out = 0*4;
  // DUT call
  k2mm(__xlx_apatb_param_alpha, __xlx_apatb_param_beta, __xlx_A__tmp_vec.data(), __xlx_B__tmp_vec.data(), __xlx_C__tmp_vec.data(), __xlx_D__tmp_vec.data(), __xlx_E_out__tmp_vec.data());
...
// print __xlx_apatb_param_E_out
for (size_t i = 0; i < __xlx_size_param_E_out; ++i) {
((Byte<4>*)__xlx_apatb_param_E_out)[i] = __xlx_E_out__tmp_vec[__xlx_offset_param_E_out+i];
}
}
