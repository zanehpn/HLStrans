set moduleName merge_sort_Pipeline_VITIS_LOOP_25_3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {merge_sort_Pipeline_VITIS_LOOP_25_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ temp float 32 regular {array 16 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ temp_q0 sc_in sc_lv 32 signal 0 } 
...
set Spec2ImplPortList { 
	temp { ap_memory {  { temp_address0 mem_address 1 4 }  { temp_ce0 mem_ce 1 1 }  { temp_q0 in_data 0 32 } } }
