...
using hls::sim::Byte;
extern "C" void gemm(float, float, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*);
extern "C" void apatb_gemm_hw(float __xlx_apatb_param_alpha, float __xlx_apatb_param_beta, volatile void * __xlx_apatb_param_A, volatile void * __xlx_apatb_param_B, volatile void * __xlx_apatb_param_C, volatile void * __xlx_apatb_param_D_out) {
...
__xlx_D_out__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_D_out)[i]);
  ...
  // DUT call
  gemm(__xlx_apatb_param_alpha, __xlx_apatb_param_beta, __xlx_A__tmp_vec.data(), __xlx_B__tmp_vec.data(), __xlx_C__tmp_vec.data(), __xlx_D_out__tmp_vec.data());
