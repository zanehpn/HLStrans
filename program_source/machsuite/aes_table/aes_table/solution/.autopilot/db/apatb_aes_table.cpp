...
// wrapc file define:
#define AUTOTB_TVIN_in_r "../tv/cdatafile/c.aes_table.autotvin_in_r.dat"
#define AUTOTB_TVOUT_in_r "../tv/cdatafile/c.aes_table.autotvout_in_r.dat"
#define AUTOTB_TVIN_out_r "../tv/cdatafile/c.aes_table.autotvin_out_r.dat"
#define AUTOTB_TVOUT_out_r "../tv/cdatafile/c.aes_table.autotvout_out_r.dat"
#define AUTOTB_TVIN_rk "../tv/cdatafile/c.aes_table.autotvin_rk.dat"
#define AUTOTB_TVOUT_rk "../tv/cdatafile/c.aes_table.autotvout_rk.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_out_r "../tv/rtldatafile/rtl.aes_table.autotvout_out_r.dat"
...
extern "C"
void aes_table_hw_stub_wrapper(void*, void*, void*);

extern "C"
void apatb_aes_table_hw(void* __xlx_apatb_param_in_r, void* __xlx_apatb_param_out_r, void* __xlx_apatb_param_rk)
{
#ifdef USE_BINARY_TV_FILE
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port2 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_rk),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_rk),
#endif
#endif
  };
  port2.param = { __xlx_apatb_param_rk };
  port2.depth = { 60 };
  port2.offset = {  };
  ...
  try {
    ...
    aes_table_hw_stub_wrapper(__xlx_apatb_param_in_r, __xlx_apatb_param_out_r, __xlx_apatb_param_rk);
