// Converted from kernel_3mm.c to .cpp by convert_and_transform_with_deepseek_auto.py
...
{
#pragma HLS ARRAY_PARTITION variable=G type=cyclic dim=2 factor=1
#pragma HLS ARRAY_PARTITION variable=G type=cyclic dim=1 factor=1
...
#pragma HLS ARRAY_PARTITION variable=C type=cyclic dim=2 factor=8
#pragma HLS ARRAY_PARTITION variable=C type=cyclic dim=1 factor=2
#pragma HLS ARRAY_PARTITION variable=F type=cyclic dim=2 factor=1
#pragma HLS ARRAY_PARTITION variable=F type=cyclic dim=1 factor=1
...
#pragma HLS ARRAY_PARTITION variable=E type=cyclic dim=2 factor=2
#pragma HLS ARRAY_PARTITION variable=E type=cyclic dim=1 factor=4
  int i, j, k;
