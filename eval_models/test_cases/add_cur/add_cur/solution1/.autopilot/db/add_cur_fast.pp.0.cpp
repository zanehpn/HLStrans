# 1 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/test_cases_3B/add_cur/add_cur_fast.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 375 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/test_cases_3B/add_cur/add_cur_fast.cpp" 2
...
# 2 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/test_cases_3B/add_cur/add_cur_fast.cpp" 2
...
# 3 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/test_cases_3B/add_cur/add_cur_fast.cpp" 2

void add_rur(ap_uint<32> n, hls::stream<ap_uint<32> >& out) {
    if (n == 0) {
        out.write(1);
        return;
    }
