...
set hasInterrupt 0
set C_modelName {aes_subBytes.1}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_aes_subBytes_1_Pipeline_glog_fu_108", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_aes_subBytes_1_Pipeline_glog_fu_108.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_aes_subBytes_1_Pipeline_alog_fu_115", "Parent" : "0", "Child" : ["4"],
	...
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_aes_subBytes_1_Pipeline_alog_fu_115.flow_control_loop_pipe_sequential_init_U", "Parent" : "3"}]}
...
set Spec2ImplPortList { 
	buf_r { ap_memory {  { buf_r_address0 mem_address 1 4 }  { buf_r_ce0 mem_ce 1 1 }  { buf_r_we0 mem_we 1 1 }  { buf_r_d0 mem_din 1 8 }  { buf_r_q0 in_data 0 8 } } }
}
