set moduleName correlation_Pipeline_VITIS_LOOP_37_5_VITIS_LOOP_39_6
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {correlation_Pipeline_VITIS_LOOP_37_5_VITIS_LOOP_39_6}
set C_modelType { void 0 }
set C_modelArgList {
	{ data int 64 regular {array 8000 { 0 1 } 1 1 }  }
	{ mean int 64 regular {array 80 { 1 3 } 1 1 }  }
	{ stddev int 64 regular {array 80 { 1 3 } 1 1 }  }
	{ tmp double 64 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "data", "interface" : "memory", "bitwidth" : 64, "direction" : "READWRITE"} , 
 	{ "Name" : "mean", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "stddev", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ data_address1 sc_out sc_lv 13 signal 0 } 
	{ data_ce1 sc_out sc_logic 1 signal 0 } 
	{ data_q1 sc_in sc_lv 64 signal 0 } 
	{ mean_address0 sc_out sc_lv 7 signal 1 } 
	{ mean_ce0 sc_out sc_logic 1 signal 1 } 
	{ mean_q0 sc_in sc_lv 64 signal 1 } 
	{ stddev_address0 sc_out sc_lv 7 signal 2 } 
	{ stddev_ce0 sc_out sc_logic 1 signal 2 } 
	{ stddev_q0 sc_in sc_lv 64 signal 2 } 
	...
	{ grp_fu_678_p_din0 sc_out sc_lv 64 signal -1 } 
	{ grp_fu_678_p_din1 sc_out sc_lv 64 signal -1 } 
	{ grp_fu_678_p_dout0 sc_in sc_lv 64 signal -1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "grp_fu_678_p_din0", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "grp_fu_678_p_din0", "role": "default" }} , 
 	{ "name": "grp_fu_678_p_din1", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "grp_fu_678_p_din1", "role": "default" }} , 
 	{ "name": "grp_fu_678_p_dout0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "grp_fu_678_p_dout0", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "8031", "Max" : "8031"}
	, {"Name" : "Interval", "Min" : "8031", "Max" : "8031"}
]}
...
set Spec2ImplPortList { 
	data { ap_memory {  { data_address0 mem_address 1 13 }  { data_ce0 mem_ce 1 1 }  { data_we0 mem_we 1 1 }  { data_d0 mem_din 1 64 }  { data_address1 MemPortADDR2 1 13 }  { data_ce1 MemPortCE2 1 1 }  { data_q1 MemPortDOUT2 0 64 } } }
	mean { ap_memory {  { mean_address0 mem_address 1 7 }  { mean_ce0 mem_ce 1 1 }  { mean_q0 mem_dout 0 64 } } }
	stddev { ap_memory {  { stddev_address0 mem_address 1 7 }  { stddev_ce0 mem_ce 1 1 }  { stddev_q0 mem_dout 0 64 } } }
