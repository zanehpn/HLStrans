...
entity latnrm_latnrm_Pipeline_VITIS_LOOP_21_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    bottom_2_out : OUT STD_LOGIC_VECTOR (31 downto 0);
    bottom_2_out_ap_vld : OUT STD_LOGIC;
    left_out : OUT STD_LOGIC_VECTOR (31 downto 0);
    left_out_ap_vld : OUT STD_LOGIC;
...
architecture behav of latnrm_latnrm_Pipeline_VITIS_LOOP_21_2 is 
...
attribute shreg_extract : string;
    ...
    signal top_7_load_1_reg_305 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal bitcast_ln27_1_fu_232_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal bitcast_ln27_1_reg_322 : STD_LOGIC_VECTOR (31 downto 0);
    signal mul_reg_327 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_pp0_stage4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_pp0_stage4 : signal is "none";
    signal ap_block_state5_pp0_stage4_iter0 : BOOLEAN;
    signal ap_block_pp0_stage4_11001 : BOOLEAN;
    signal mul2_reg_332 : STD_LOGIC_VECTOR (31 downto 0);
    signal mul3_reg_337 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_pp0_stage5 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_pp0_stage5 : signal is "none";
    signal ap_block_state6_pp0_stage5_iter0 : BOOLEAN;
    signal ap_block_pp0_stage5_11001 : BOOLEAN;
    signal mul4_reg_342 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal top_7_fu_56 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_block_pp0_stage1 : BOOLEAN;
    signal bottom_2_fu_60 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal shl_ln_fu_178_p3 : STD_LOGIC_VECTOR (6 downto 0);
...
begin
    ...
    bottom_2_fu_60_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
                bottom_2_fu_60 <= bottom;
            elsif (((ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
                bottom_2_fu_60 <= grp_fu_6358_p_dout0;
            end if; 
        end if;
    end process;
    ...
    top_7_fu_56_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    ...
                    top_7_fu_56 <= grp_fu_6358_p_dout0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln21_reg_286 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then
                bitcast_ln27_1_reg_322 <= bitcast_ln27_1_fu_232_p1;
                bitcast_ln27_reg_317 <= bitcast_ln27_fu_227_p1;
                right_reg_311 <= right_fu_222_p1;
                top_7_load_1_reg_305 <= top_7_fu_56;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln21_reg_286 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage4_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage4))) then
                mul2_reg_332 <= grp_fu_1106_p_dout0;
                mul_reg_327 <= grp_fu_1102_p_dout0;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln21_reg_286 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage5_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage5))) then
                mul3_reg_337 <= grp_fu_1102_p_dout0;
                mul4_reg_342 <= grp_fu_1106_p_dout0;
            end if;
        end if;
    end process;
    ...
    add_ln21_fu_207_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_j_5) + unsigned(ap_const_lv6_1));
    add_ln27_fu_186_p2 <= std_logic_vector(unsigned(shl_ln_fu_178_p3) + unsigned(ap_const_lv7_7C));
    ...
    ap_sig_allocacmp_j_5_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, j_fu_64)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_j_5 <= ap_const_lv6_1;
        else 
            ap_sig_allocacmp_j_5 <= j_fu_64;
        end if; 
    end process;

    bitcast_ln27_1_fu_232_p1 <= coefficient_q0;
    bitcast_ln27_fu_227_p1 <= coefficient_q1;
    bottom_2_out <= bottom_2_fu_60;

    bottom_2_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage1, icmp_ln21_reg_286, ap_block_pp0_stage1_11001)
    begin
        if (((icmp_ln21_reg_286 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
            bottom_2_out_ap_vld <= ap_const_logic_1;
        else 
            bottom_2_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;
    ...
    grp_fu_132_p0_assign_proc : process(ap_enable_reg_pp0_iter0, mul_reg_327, mul3_reg_337, ap_CS_fsm_pp0_stage5, ap_block_pp0_stage5, ap_CS_fsm_pp0_stage6, ap_block_pp0_stage6)
    begin
        if ((ap_enable_reg_pp0_iter0 = ap_const_logic_1)) then
            if (((ap_const_boolean_0 = ap_block_pp0_stage6) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage6))) then 
                grp_fu_132_p0 <= mul3_reg_337;
            elsif (((ap_const_boolean_0 = ap_block_pp0_stage5) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage5))) then 
                grp_fu_132_p0 <= mul_reg_327;
            else 
    ...
    grp_fu_132_p1_assign_proc : process(ap_enable_reg_pp0_iter0, mul2_reg_332, ap_CS_fsm_pp0_stage5, mul4_reg_342, ap_block_pp0_stage5, ap_CS_fsm_pp0_stage6, ap_block_pp0_stage6)
    begin
        if ((ap_enable_reg_pp0_iter0 = ap_const_logic_1)) then
            if (((ap_const_boolean_0 = ap_block_pp0_stage6) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage6))) then 
                grp_fu_132_p1 <= mul4_reg_342;
            elsif (((ap_const_boolean_0 = ap_block_pp0_stage5) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage5))) then 
                grp_fu_132_p1 <= mul2_reg_332;
            else 
    ...
    grp_fu_136_p1_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage1, right_reg_311, top_7_fu_56, ap_block_pp0_stage1, ap_CS_fsm_pp0_stage2, ap_block_pp0_stage2)
    begin
        if ((ap_enable_reg_pp0_iter0 = ap_const_logic_1)) then
            if (((ap_const_boolean_0 = ap_block_pp0_stage2) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then 
                grp_fu_136_p1 <= right_reg_311;
            elsif (((ap_const_boolean_0 = ap_block_pp0_stage1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
                grp_fu_136_p1 <= top_7_fu_56;
            else 
    ...
    grp_fu_140_p0_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage1, bitcast_ln27_1_fu_232_p1, bitcast_ln27_1_reg_322, ap_block_pp0_stage1, ap_CS_fsm_pp0_stage2, ap_block_pp0_stage2)
    begin
        if ((ap_enable_reg_pp0_iter0 = ap_const_logic_1)) then
            if (((ap_const_boolean_0 = ap_block_pp0_stage2) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then 
                grp_fu_140_p0 <= bitcast_ln27_1_reg_322;
            elsif (((ap_const_boolean_0 = ap_block_pp0_stage1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
                grp_fu_140_p0 <= bitcast_ln27_1_fu_232_p1;
            else 
    ...
    grp_fu_140_p1_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage1, top_7_load_1_reg_305, right_fu_222_p1, ap_block_pp0_stage1, ap_CS_fsm_pp0_stage2, ap_block_pp0_stage2)
    begin
        if ((ap_enable_reg_pp0_iter0 = ap_const_logic_1)) then
            if (((ap_const_boolean_0 = ap_block_pp0_stage2) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then 
                grp_fu_140_p1 <= top_7_load_1_reg_305;
            elsif (((ap_const_boolean_0 = ap_block_pp0_stage1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
    ...
    icmp_ln21_fu_162_p2 <= "1" when (ap_sig_allocacmp_j_5 = ap_const_lv6_20) else "0";
    ...
    internal_state_d0 <= bottom_2_fu_60;
    ...
    left_out <= top_7_fu_56;

    left_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage1, icmp_ln21_reg_286, ap_block_pp0_stage1_11001)
    begin
        if (((icmp_ln21_reg_286 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
            left_out_ap_vld <= ap_const_logic_1;
        else 
            left_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    lshr_ln_fu_192_p4 <= add_ln27_fu_186_p2(6 downto 2);
    right_fu_222_p1 <= internal_state_q0;
    shl_ln_fu_178_p3 <= (trunc_ln27_fu_174_p1 & ap_const_lv2_0);
    trunc_ln27_fu_174_p1 <= ap_sig_allocacmp_j_5(5 - 1 downto 0);
    zext_ln21_fu_168_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_j_5),64));
    zext_ln27_fu_202_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(lshr_ln_fu_192_p4),64));
end behav;
