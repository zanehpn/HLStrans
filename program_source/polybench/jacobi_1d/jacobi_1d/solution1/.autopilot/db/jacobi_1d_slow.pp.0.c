# 1 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/jacobi_1d/jacobi_1d_slow.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/jacobi_1d/jacobi_1d_slow.c" 2

__attribute__((sdx_kernel("jacobi_1d", 0))) void jacobi_1d(int tsteps,int n,double A[120],double B[120])
{
#line 7 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/jacobi_1d/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=jacobi_1d
# 3 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/jacobi_1d/jacobi_1d_slow.c"
  ...
  VITIS_LOOP_9_1: for (t = 0; t < 40; t++) {

    VITIS_LOOP_11_2: for (i = 1; i < 120 - 1; i++) {
      B[i] = 0.33333 * (A[i - 1] + A[i] + A[i + 1]);
    }

    VITIS_LOOP_15_3: for (i = 1; i < 120 - 1; i++) {
