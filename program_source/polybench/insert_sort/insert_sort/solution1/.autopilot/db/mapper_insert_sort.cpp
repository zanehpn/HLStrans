...
using hls::sim::Byte;
extern "C" void insert_sort(Byte<4>*);
extern "C" void apatb_insert_sort_hw(volatile void * __xlx_apatb_param_A) {
...
__xlx_A__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_A)[i]);
  ...
  int __xlx_size_param_A = 10240;
  int __xlx_offset_param_A = 0;
  int __xlx_offset_byte_param_A = 0*4;
  // DUT call
  insert_sort(__xlx_A__tmp_vec.data());
