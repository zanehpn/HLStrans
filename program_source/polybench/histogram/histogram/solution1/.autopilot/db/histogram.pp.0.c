# 1 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/histogram/histogram.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/histogram/histogram.c" 2
# 1 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/histogram/histogram.h" 1



__attribute__((sdx_kernel("histogram", 0))) extern void histogram(int in[70], int hist[256]);
# 2 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/histogram/histogram.c" 2


__attribute__((sdx_kernel("histogram", 0))) void histogram(int in[70], int hist[256]) {
#line 7 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/histogram/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=histogram
# 4 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/histogram/histogram.c"

    int val;
    VITIS_LOOP_6_1: for (int i = 0; i < 70; i++) {
        val = in[i];
        hist[val] = hist[val] + 1;
    }
}
