...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename buff_p \
    op interface \
    ports { buff_p_address0 { O 6 vector } buff_p_ce0 { O 1 bit } buff_p_we0 { O 1 bit } buff_p_d0 { O 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'buff_p'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename buff_r \
    op interface \
    ports { buff_r_address0 { O 6 vector } buff_r_ce0 { O 1 bit } buff_r_we0 { O 1 bit } buff_r_d0 { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename buff_s_out \
    op interface \
    ports { buff_s_out_address0 { O 6 vector } buff_s_out_ce0 { O 1 bit } buff_s_out_we0 { O 1 bit } buff_s_out_d0 { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename buff_q_out \
    op interface \
    ports { buff_q_out_address0 { O 6 vector } buff_q_out_ce0 { O 1 bit } buff_q_out_we0 { O 1 bit } buff_q_out_d0 { O 32 vector } } \
} "
} else {
