...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("C_out_address0", 12, hls_out, 4, "ap_memory", "mem_address", 1),
	Port_Property("C_out_ce0", 1, hls_out, 4, "ap_memory", "mem_ce", 1),
	Port_Property("C_out_we0", 1, hls_out, 4, "ap_memory", "mem_we", 1),
	Port_Property("C_out_d0", 32, hls_out, 4, "ap_memory", "mem_din", 1),
};
const char* HLS_Design_Meta::dut_name = "syrk";
