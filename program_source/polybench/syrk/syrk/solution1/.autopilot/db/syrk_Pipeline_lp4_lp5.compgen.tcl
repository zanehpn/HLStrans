...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename buff_C_out \
    op interface \
    ports { buff_C_out_address0 { O 12 vector } buff_C_out_ce0 { O 1 bit } buff_C_out_we0 { O 1 bit } buff_C_out_d0 { O 32 vector } buff_C_out_address1 { O 12 vector } buff_C_out_ce1 { O 1 bit } buff_C_out_q1 { I 32 vector } } \
} "
} else {
