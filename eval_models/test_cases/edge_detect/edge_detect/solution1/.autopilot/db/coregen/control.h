...
#define CONTROL_ADDR_INPUTIMAGE_DATA  0x10
#define CONTROL_BITS_INPUTIMAGE_DATA  64
#define CONTROL_ADDR_OUTPUTIMAGE_DATA 0x1c
#define CONTROL_BITS_OUTPUTIMAGE_DATA 64
