// Converted from kernel_adi.c to .cpp by convert_and_transform_with_deepseek_auto.py
...
{
#pragma HLS ARRAY_PARTITION variable=q type=cyclic dim=2 factor=2
#pragma HLS ARRAY_PARTITION variable=q type=cyclic dim=1 factor=1
#pragma HLS ARRAY_PARTITION variable=p type=cyclic dim=2 factor=2
...
#pragma HLS ARRAY_PARTITION variable=v type=cyclic dim=1 factor=2
