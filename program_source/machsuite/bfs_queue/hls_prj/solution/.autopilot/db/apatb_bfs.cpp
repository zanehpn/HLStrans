...
extern "C"
void bfs_hw_stub_wrapper(void*, void*, hls::sim::Byte<8>, void*, void*);

extern "C"
void apatb_bfs_hw(void* __xlx_apatb_param_nodes, void* __xlx_apatb_param_edges, hls::sim::Byte<8> __xlx_apatb_param_starting_node, void* __xlx_apatb_param_level, void* __xlx_apatb_param_level_counts)
{
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_starting_node),
#endif
  };
  port0.param = &__xlx_apatb_param_starting_node;
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port1 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_nodes),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_nodes),
#endif
#endif
  };
  port1.param = { __xlx_apatb_param_nodes };
  port1.depth = { 256 };
  port1.offset = {  };
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port2 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_edges),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_edges),
#endif
#endif
  };
  port2.param = { __xlx_apatb_param_edges };
  port2.depth = { 4096 };
  port2.offset = {  };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_level),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_level),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_level),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_level),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_level),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_level),
#endif
#endif
  };
  port3.param = { __xlx_apatb_param_level };
  port3.depth = { 256 };
  port3.offset = {  };
  port3.hasWrite = { true };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_level_counts),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_level_counts),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_level_counts),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_level_counts),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_level_counts),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_level_counts),
#endif
#endif
  };
  port4.param = { __xlx_apatb_param_level_counts };
  port4.depth = { 10 };
  port4.offset = {  };
  port4.hasWrite = { true };
