...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename accum_V \
    op interface \
    ports { accum_V_address0 { O 10 vector } accum_V_ce0 { O 1 bit } accum_V_q0 { I 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename accum_V_1 \
    op interface \
    ports { accum_V_1_address0 { O 10 vector } accum_V_1_ce0 { O 1 bit } accum_V_1_q0 { I 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename accum_V_2 \
    op interface \
    ports { accum_V_2_address0 { O 10 vector } accum_V_2_ce0 { O 1 bit } accum_V_2_q0 { I 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename accum_V_3 \
    op interface \
    ports { accum_V_3_address0 { O 10 vector } accum_V_3_ce0 { O 1 bit } accum_V_3_q0 { I 16 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_zext_ln103_5 \
    op interface \
    ports { zext_ln103_5 { I 12 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_trunc_ln103 \
    op interface \
    ports { trunc_ln103 { I 2 vector } } \
} "
}
