set moduleName gesummv_Pipeline_lp5
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {gesummv_Pipeline_lp5}
set C_modelType { void 0 }
set C_modelArgList {
	{ tmp1 float 32 regular {array 64 { 1 3 } 1 1 }  }
	{ tmp2 float 32 regular {array 64 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ tmp2_address0 sc_out sc_lv 6 signal 1 } 
	{ tmp2_ce0 sc_out sc_logic 1 signal 1 } 
	{ tmp2_q0 sc_in sc_lv 32 signal 1 } 
	{ buff_y_out_address0 sc_out sc_lv 6 signal 2 } 
	{ buff_y_out_ce0 sc_out sc_logic 1 signal 2 } 
	{ buff_y_out_we0 sc_out sc_logic 1 signal 2 } 
	{ buff_y_out_d0 sc_out sc_lv 32 signal 2 } 
...
set Spec2ImplPortList { 
	...
	tmp2 { ap_memory {  { tmp2_address0 mem_address 1 6 }  { tmp2_ce0 mem_ce 1 1 }  { tmp2_q0 mem_dout 0 32 } } }
