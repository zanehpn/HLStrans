; ModuleID = '/home/zqy/LLM4CHIP/dataset/pair_slow_fast/syn_dataset/polybench/k2mm/k2mm/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_k2mm_ir(float %alpha, float %beta, [64 x float]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="64" %A, [64 x float]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="64" %B, [64 x float]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="64" %C, [64 x float]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="64" %D, [64 x float]* noalias nocapture nonnull "fpga.decayed.dim.hint"="64" %E_out) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_k2mm_hw(float %alpha, float %beta, [64 x float]* %5, [64 x float]* %6, [64 x float]* %7, [64 x float]* %8, [64 x float]* %9)
...
declare void @apatb_k2mm_hw(float, float, [64 x float]*, [64 x float]*, [64 x float]*, [64 x float]*, [64 x float]*)
...
define void @k2mm_hw_stub_wrapper(float, float, [64 x float]*, [64 x float]*, [64 x float]*, [64 x float]*, [64 x float]*) #4 {
entry:
  ...
  %10 = bitcast [64 x float]* %5 to [64 x [64 x float]]*
  %11 = bitcast [64 x float]* %6 to [64 x [64 x float]]*
  call void @copy_out([64 x [64 x float]]* null, [64 x [64 x float]]* %7, [64 x [64 x float]]* null, [64 x [64 x float]]* %8, [64 x [64 x float]]* null, [64 x [64 x float]]* %9, [64 x [64 x float]]* null, [64 x [64 x float]]* %10, [64 x [64 x float]]* null, [64 x [64 x float]]* %11)
  ...
  call void @k2mm_hw_stub(float %0, float %1, [64 x float]* %12, [64 x float]* %13, [64 x float]* %14, [64 x float]* %15, [64 x float]* %16)
  call void @copy_in([64 x [64 x float]]* null, [64 x [64 x float]]* %7, [64 x [64 x float]]* null, [64 x [64 x float]]* %8, [64 x [64 x float]]* null, [64 x [64 x float]]* %9, [64 x [64 x float]]* null, [64 x [64 x float]]* %10, [64 x [64 x float]]* null, [64 x [64 x float]]* %11)
  ret void
}

declare void @k2mm_hw_stub(float, float, [64 x float]*, [64 x float]*, [64 x float]*, [64 x float]*, [64 x float]*)
