# 1 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/adi/adi_slow.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/adi/adi_slow.c" 2

__attribute__((sdx_kernel("adi", 0))) void adi(int tsteps,int n,double u[60][60],double v[60][60],double p[60][60],double q[60][60])
{
#line 7 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/adi/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=adi
# 3 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/adi/adi_slow.c"
  ...
  VITIS_LOOP_36_1: for (t = 1; t <= 40; t++) {
    ...
    VITIS_LOOP_41_2: for (i = 1; i < 59; i++) {
      ...
      VITIS_LOOP_52_4: for (j = 0; j <= 57; j++) {
        int _in_j_0 = 58 + -1 * j;
    ...
    VITIS_LOOP_59_5: for (i = 1; i < 59; i++) {
      u[i][0] = 1.0;
      p[i][0] = 0.0;
      q[i][0] = u[i][0];

      VITIS_LOOP_64_6: for (j = 1; j < 59; j++) {
        p[i][j] = -f / (d * p[i][j - 1] + e);
        q[i][j] = (-a * v[i - 1][j] + (1.0 + 2.0 * a) * v[i][j] - c * v[i + 1][j] - d * q[i][j - 1]) / (d * p[i][j - 1] + e);
      }
      u[i][60 - 1] = 1.0;

      VITIS_LOOP_70_7: for (j = 0; j <= 57; j++) {
        int _in_j = 58 + -1 * j;
