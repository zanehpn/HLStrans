set moduleName gemm_Pipeline_lprd_1_lprd_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {gemm_Pipeline_lprd_1_lprd_2}
...
set portList { 
	...
	{ buff_A_address0 sc_out sc_lv 12 signal 3 } 
	...
	{ buff_C_address0 sc_out sc_lv 12 signal 5 } 
	{ buff_C_ce0 sc_out sc_logic 1 signal 5 } 
	{ buff_C_we0 sc_out sc_logic 1 signal 5 } 
	{ buff_C_d0 sc_out sc_lv 32 signal 5 } 
	{ tmp1_address0 sc_out sc_lv 12 signal 6 } 
	{ tmp1_ce0 sc_out sc_logic 1 signal 6 } 
	{ tmp1_we0 sc_out sc_logic 1 signal 6 } 
	{ tmp1_d0 sc_out sc_lv 32 signal 6 } 
}
set NewPortList {[ 
