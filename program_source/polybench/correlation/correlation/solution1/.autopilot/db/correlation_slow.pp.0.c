# 1 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/correlation/correlation_slow.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 338 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/correlation/correlation_slow.c" 2
...
# 2 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/correlation/correlation_slow.c" 2

__attribute__((sdx_kernel("correlation", 0))) void correlation(double float_n,double data[100][80],double corr[80][80],double mean[80],double stddev[80])
{
#line 7 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/correlation/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=correlation
# 4 "/home/zqy/LLM4CHIP/dataset/pair_slow_fast/SYN_dataset/polybench/correlation/correlation_slow.c"
  ...
  VITIS_LOOP_10_1: for (j = 0; j < 80; j++) {
    mean[j] = 0.0;

    VITIS_LOOP_13_2: for (i = 0; i < 100; i++) {
      mean[j] += data[i][j];
    }
    mean[j] /= float_n;
  }
  ...
  VITIS_LOOP_20_3: for (j = 0; j < 80; j++) {
    stddev[j] = 0.0;

    VITIS_LOOP_23_4: for (i = 0; i < 100; i++) {
  ...
  VITIS_LOOP_37_5: for (i = 0; i < 100; i++) {

    VITIS_LOOP_39_6: for (j = 0; j < 80; j++) {
      data[i][j] -= mean[j];
  ...
  VITIS_LOOP_48_7: for (i = 0; i < 80 - 1; i++) {
    corr[i][i] = 1.0;

    VITIS_LOOP_51_8: for (j = i + 1; j < 80; j++) {
      corr[i][j] = 0.0;

      VITIS_LOOP_54_9: for (k = 0; k < 100; k++) {
