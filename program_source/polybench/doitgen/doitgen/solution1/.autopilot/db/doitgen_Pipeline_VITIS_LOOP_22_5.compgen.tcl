...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename A \
    op interface \
    ports { A_address0 { O 14 vector } A_ce0 { O 1 bit } A_we0 { O 1 bit } A_d0 { O 64 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename sum \
    op interface \
    ports { sum_address0 { O 5 vector } sum_ce0 { O 1 bit } sum_q0 { I 64 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sub_ln19 \
    op interface \
    ports { sub_ln19 { I 14 vector } } \
} "
}
