set moduleName gemm_Pipeline_lpwr_1_lpwr_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {gemm_Pipeline_lpwr_1_lpwr_2}
...
set Spec2ImplPortList { 
	...
	buff_C { ap_memory {  { buff_C_address0 mem_address 1 12 }  { buff_C_ce0 mem_ce 1 1 }  { buff_C_q0 in_data 0 32 } } }
}
