// Converted from kernel_gemver.c to .cpp by convert_and_transform_with_deepseek_auto.py
...
#pragma HLS ARRAY_PARTITION variable=w type=cyclic dim=1 factor=2
#pragma HLS ARRAY_PARTITION variable=v2 type=cyclic dim=1 factor=4
#pragma HLS ARRAY_PARTITION variable=u2 type=cyclic dim=1 factor=1
#pragma HLS ARRAY_PARTITION variable=v1 type=cyclic dim=1 factor=4
#pragma HLS ARRAY_PARTITION variable=u1 type=cyclic dim=1 factor=4
