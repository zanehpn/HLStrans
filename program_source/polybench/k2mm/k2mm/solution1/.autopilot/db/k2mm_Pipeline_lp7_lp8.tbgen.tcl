...
set C_modelArgList {
	{ buff_D float 32 regular {array 4096 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ buff_D_address0 sc_out sc_lv 12 signal 0 } 
...
set Spec2ImplPortList { 
	buff_D { ap_memory {  { buff_D_address0 mem_address 1 12 }  { buff_D_ce0 mem_ce 1 1 }  { buff_D_q0 mem_dout 0 32 } } }
